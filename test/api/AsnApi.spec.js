...
(function(root, factory) {
  ...
  describe('AsnApi', function() {
    ...
    describe('closeAsn', function() {
      it('should call closeAsn successfully', function(done) {
        //uncomment below and update the code to test closeAsn
        //instance.closeAsn(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
