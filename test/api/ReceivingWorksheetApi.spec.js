...
(function(root, factory) {
  ...
  describe('ReceivingWorksheetApi', function() {
    ...
    describe('addReceivingWorksheetFile', function() {
      it('should call addReceivingWorksheetFile successfully', function(done) {
        //uncomment below and update the code to test addReceivingWorksheetFile
        //instance.addReceivingWorksheetFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addReceivingWorksheetFileByURL', function() {
      it('should call addReceivingWorksheetFileByURL successfully', function(done) {
        //uncomment below and update the code to test addReceivingWorksheetFileByURL
        //instance.addReceivingWorksheetFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteReceivingWorksheetFile', function() {
      it('should call deleteReceivingWorksheetFile successfully', function(done) {
        //uncomment below and update the code to test deleteReceivingWorksheetFile
        //instance.deleteReceivingWorksheetFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getReceivingWorksheetFiles', function() {
      it('should call getReceivingWorksheetFiles successfully', function(done) {
        //uncomment below and update the code to test getReceivingWorksheetFiles
        //instance.getReceivingWorksheetFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
