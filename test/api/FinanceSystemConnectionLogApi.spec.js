...
(function(root, factory) {
  ...
  describe('FinanceSystemConnectionLogApi', function() {
    ...
    describe('addFinanceSystemConnectionLogFile', function() {
      it('should call addFinanceSystemConnectionLogFile successfully', function(done) {
        //uncomment below and update the code to test addFinanceSystemConnectionLogFile
        //instance.addFinanceSystemConnectionLogFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addFinanceSystemConnectionLogFileByURL', function() {
      it('should call addFinanceSystemConnectionLogFileByURL successfully', function(done) {
        //uncomment below and update the code to test addFinanceSystemConnectionLogFileByURL
        //instance.addFinanceSystemConnectionLogFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteFinanceSystemConnectionLogFile', function() {
      it('should call deleteFinanceSystemConnectionLogFile successfully', function(done) {
        //uncomment below and update the code to test deleteFinanceSystemConnectionLogFile
        //instance.deleteFinanceSystemConnectionLogFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFinanceSystemConnectionLogFiles', function() {
      it('should call getFinanceSystemConnectionLogFiles successfully', function(done) {
        //uncomment below and update the code to test getFinanceSystemConnectionLogFiles
        //instance.getFinanceSystemConnectionLogFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
