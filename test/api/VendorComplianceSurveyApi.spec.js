...
(function(root, factory) {
  ...
  describe('VendorComplianceSurveyApi', function() {
    ...
    describe('addVendorComplianceSurveyFile', function() {
      it('should call addVendorComplianceSurveyFile successfully', function(done) {
        //uncomment below and update the code to test addVendorComplianceSurveyFile
        //instance.addVendorComplianceSurveyFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addVendorComplianceSurveyFileByURL', function() {
      it('should call addVendorComplianceSurveyFileByURL successfully', function(done) {
        //uncomment below and update the code to test addVendorComplianceSurveyFileByURL
        //instance.addVendorComplianceSurveyFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteVendorComplianceSurveyFile', function() {
      it('should call deleteVendorComplianceSurveyFile successfully', function(done) {
        //uncomment below and update the code to test deleteVendorComplianceSurveyFile
        //instance.deleteVendorComplianceSurveyFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getVendorComplianceSurveyFiles', function() {
      it('should call getVendorComplianceSurveyFiles successfully', function(done) {
        //uncomment below and update the code to test getVendorComplianceSurveyFiles
        //instance.getVendorComplianceSurveyFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
