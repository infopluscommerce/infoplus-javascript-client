...
(function(root, factory) {
  ...
  describe('ItemSectorApi', function() {
    ...
    describe('addItemSectorFileByURL', function() {
      it('should call addItemSectorFileByURL successfully', function(done) {
        //uncomment below and update the code to test addItemSectorFileByURL
        //instance.addItemSectorFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteItemSectorFile', function() {
      it('should call deleteItemSectorFile successfully', function(done) {
        //uncomment below and update the code to test deleteItemSectorFile
        //instance.deleteItemSectorFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getItemSectorFiles', function() {
      it('should call getItemSectorFiles successfully', function(done) {
        //uncomment below and update the code to test getItemSectorFiles
        //instance.getItemSectorFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
