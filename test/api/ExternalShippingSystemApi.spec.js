...
(function(root, factory) {
  ...
  describe('ExternalShippingSystemApi', function() {
    ...
    describe('addExternalShippingSystemFileByURL', function() {
      it('should call addExternalShippingSystemFileByURL successfully', function(done) {
        //uncomment below and update the code to test addExternalShippingSystemFileByURL
        //instance.addExternalShippingSystemFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteExternalShippingSystemFile', function() {
      it('should call deleteExternalShippingSystemFile successfully', function(done) {
        //uncomment below and update the code to test deleteExternalShippingSystemFile
        //instance.deleteExternalShippingSystemFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getExternalShippingSystemFiles', function() {
      it('should call getExternalShippingSystemFiles successfully', function(done) {
        //uncomment below and update the code to test getExternalShippingSystemFiles
        //instance.getExternalShippingSystemFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
