...
(function(root, factory) {
  ...
  describe('OrderSourceApi', function() {
    ...
    describe('addOrderSourceFile', function() {
      it('should call addOrderSourceFile successfully', function(done) {
        //uncomment below and update the code to test addOrderSourceFile
        //instance.addOrderSourceFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addOrderSourceFileByURL', function() {
      it('should call addOrderSourceFileByURL successfully', function(done) {
        //uncomment below and update the code to test addOrderSourceFileByURL
        //instance.addOrderSourceFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteOrderSourceFile', function() {
      it('should call deleteOrderSourceFile successfully', function(done) {
        //uncomment below and update the code to test deleteOrderSourceFile
        //instance.deleteOrderSourceFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOrderSourceFiles', function() {
      it('should call getOrderSourceFiles successfully', function(done) {
        //uncomment below and update the code to test getOrderSourceFiles
        //instance.getOrderSourceFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
