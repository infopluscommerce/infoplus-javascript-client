...
(function(root, factory) {
  ...
  describe('JobTimeActivityApi', function() {
    ...
    describe('addJobTimeActivityFile', function() {
      it('should call addJobTimeActivityFile successfully', function(done) {
        //uncomment below and update the code to test addJobTimeActivityFile
        //instance.addJobTimeActivityFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addJobTimeActivityFileByURL', function() {
      it('should call addJobTimeActivityFileByURL successfully', function(done) {
        //uncomment below and update the code to test addJobTimeActivityFileByURL
        //instance.addJobTimeActivityFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteJobTimeActivityFile', function() {
      it('should call deleteJobTimeActivityFile successfully', function(done) {
        //uncomment below and update the code to test deleteJobTimeActivityFile
        //instance.deleteJobTimeActivityFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getJobTimeActivityFiles', function() {
      it('should call getJobTimeActivityFiles successfully', function(done) {
        //uncomment below and update the code to test getJobTimeActivityFiles
        //instance.getJobTimeActivityFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
