...
(function(root, factory) {
  ...
  describe('ManageScheduledPlansApi', function() {
    ...
    describe('addManageScheduledPlansFile', function() {
      it('should call addManageScheduledPlansFile successfully', function(done) {
        //uncomment below and update the code to test addManageScheduledPlansFile
        //instance.addManageScheduledPlansFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addManageScheduledPlansFileByURL', function() {
      it('should call addManageScheduledPlansFileByURL successfully', function(done) {
        //uncomment below and update the code to test addManageScheduledPlansFileByURL
        //instance.addManageScheduledPlansFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteManageScheduledPlansFile', function() {
      it('should call deleteManageScheduledPlansFile successfully', function(done) {
        //uncomment below and update the code to test deleteManageScheduledPlansFile
        //instance.deleteManageScheduledPlansFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getManageScheduledPlansFiles', function() {
      it('should call getManageScheduledPlansFiles successfully', function(done) {
        //uncomment below and update the code to test getManageScheduledPlansFiles
        //instance.getManageScheduledPlansFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
