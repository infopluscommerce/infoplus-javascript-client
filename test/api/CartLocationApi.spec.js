...
(function(root, factory) {
  ...
  describe('CartLocationApi', function() {
    ...
    describe('addCartLocationFile', function() {
      it('should call addCartLocationFile successfully', function(done) {
        //uncomment below and update the code to test addCartLocationFile
        //instance.addCartLocationFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('addCartLocationFileByURL', function() {
      it('should call addCartLocationFileByURL successfully', function(done) {
        //uncomment below and update the code to test addCartLocationFileByURL
        //instance.addCartLocationFileByURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteCartLocationFile', function() {
      it('should call deleteCartLocationFile successfully', function(done) {
        //uncomment below and update the code to test deleteCartLocationFile
        //instance.deleteCartLocationFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCartLocationFiles', function() {
      it('should call getCartLocationFiles successfully', function(done) {
        //uncomment below and update the code to test getCartLocationFiles
        //instance.getCartLocationFiles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
