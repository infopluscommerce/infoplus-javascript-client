...
(function(root, factory) {
  ...
  describe('Shipment', function() {
    ...
    it('should have the property manifestPartnerOrderId (base name: "manifestPartnerOrderId")', function() {
      // uncomment below and update the code to test the property manifestPartnerOrderId
      //var instane = new infoplus.Shipment();
      //expect(instance).to.be();
    });
