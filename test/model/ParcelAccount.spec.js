...
(function(root, factory) {
  ...
  describe('ParcelAccount', function() {
    ...
    it('should have the property manifestPartner (base name: "manifestPartner")', function() {
      // uncomment below and update the code to test the property manifestPartner
      //var instane = new infoplus.ParcelAccount();
      //expect(instance).to.be();
    });
