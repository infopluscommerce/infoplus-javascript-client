...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.LoadContent();
  });
  ...
  describe('LoadContent', function() {
    it('should create an instance of LoadContent', function() {
      // uncomment below and update the code to test LoadContent
      //var instane = new infoplus.LoadContent();
      //expect(instance).to.be.a(infoplus.LoadContent);
    });
