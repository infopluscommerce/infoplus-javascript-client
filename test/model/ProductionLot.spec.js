...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.ProductionLot();
  });
  ...
  describe('ProductionLot', function() {
    it('should create an instance of ProductionLot', function() {
      // uncomment below and update the code to test ProductionLot
      //var instane = new infoplus.ProductionLot();
      //expect(instance).to.be.a(infoplus.ProductionLot);
    });
