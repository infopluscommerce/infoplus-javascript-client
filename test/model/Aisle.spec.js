...
(function(root, factory) {
  ...
  describe('Aisle', function() {
    it('should create an instance of Aisle', function() {
      // uncomment below and update the code to test Aisle
      //var instane = new infoplus.Aisle();
      //expect(instance).to.be.a(infoplus.Aisle);
    });
