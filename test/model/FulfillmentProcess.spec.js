...
(function(root, factory) {
  ...
  describe('FulfillmentProcess', function() {
    ...
    it('should have the property selectAlternatePickLocation (base name: "selectAlternatePickLocation")', function() {
      // uncomment below and update the code to test the property selectAlternatePickLocation
      //var instane = new infoplus.FulfillmentProcess();
      //expect(instance).to.be();
    });
    ...
    it('should have the property autoCreateCycleCountWork (base name: "autoCreateCycleCountWork")', function() {
      // uncomment below and update the code to test the property autoCreateCycleCountWork
      //var instane = new infoplus.FulfillmentProcess();
      //expect(instance).to.be();
    });

    it('should have the property autoAdjustmentTolerance (base name: "autoAdjustmentTolerance")', function() {
      // uncomment below and update the code to test the property autoAdjustmentTolerance
      //var instane = new infoplus.FulfillmentProcess();
      //expect(instance).to.be();
    });
