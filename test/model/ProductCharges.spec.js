...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.ProductCharges();
  });
  ...
  describe('ProductCharges', function() {
    it('should create an instance of ProductCharges', function() {
      // uncomment below and update the code to test ProductCharges
      //var instane = new infoplus.ProductCharges();
      //expect(instance).to.be.a(infoplus.ProductCharges);
    });
