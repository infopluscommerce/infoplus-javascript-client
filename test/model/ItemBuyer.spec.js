...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.ItemBuyer();
  });
  ...
  describe('ItemBuyer', function() {
    it('should create an instance of ItemBuyer', function() {
      // uncomment below and update the code to test ItemBuyer
      //var instane = new infoplus.ItemBuyer();
      //expect(instance).to.be.a(infoplus.ItemBuyer);
    });
