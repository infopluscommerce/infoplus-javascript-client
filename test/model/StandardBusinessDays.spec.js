...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.StandardBusinessDays();
  });
  ...
  describe('StandardBusinessDays', function() {
    it('should create an instance of StandardBusinessDays', function() {
      // uncomment below and update the code to test StandardBusinessDays
      //var instane = new infoplus.StandardBusinessDays();
      //expect(instance).to.be.a(infoplus.StandardBusinessDays);
    });
