...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.CartLocation();
  });
  ...
  describe('CartLocation', function() {
    it('should create an instance of CartLocation', function() {
      // uncomment below and update the code to test CartLocation
      //var instane = new infoplus.CartLocation();
      //expect(instance).to.be.a(infoplus.CartLocation);
    });
