...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.QuickAdjustment();
  });
  ...
  describe('QuickAdjustment', function() {
    it('should create an instance of QuickAdjustment', function() {
      // uncomment below and update the code to test QuickAdjustment
      //var instane = new infoplus.QuickAdjustment();
      //expect(instance).to.be.a(infoplus.QuickAdjustment);
    });
    ...
    it('should have the property changeQuantity (base name: "changeQuantity")', function() {
      // uncomment below and update the code to test the property changeQuantity
      //var instane = new infoplus.QuickAdjustment();
      //expect(instance).to.be();
    });
