...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.WorkProduct();
  });
  ...
  describe('WorkProduct', function() {
    it('should create an instance of WorkProduct', function() {
      // uncomment below and update the code to test WorkProduct
      //var instane = new infoplus.WorkProduct();
      //expect(instance).to.be.a(infoplus.WorkProduct);
    });
