...
(function(root, factory) {
  ...
  describe('CartonType', function() {
    ...
    it('should have the property noOfCavities (base name: "noOfCavities")', function() {
      // uncomment below and update the code to test the property noOfCavities
      //var instane = new infoplus.CartonType();
      //expect(instance).to.be();
    });

    it('should have the property materialDescription (base name: "materialDescription")', function() {
