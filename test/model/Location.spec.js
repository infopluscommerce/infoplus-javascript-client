...
(function(root, factory) {
  ...
  describe('Location', function() {
    ...
    it('should have the property contentMixingRule (base name: "contentMixingRule")', function() {
      // uncomment below and update the code to test the property contentMixingRule
      //var instane = new infoplus.Location();
      //expect(instance).to.be();
    });
