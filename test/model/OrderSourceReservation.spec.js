...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.OrderSourceReservation();
  });
  ...
  describe('OrderSourceReservation', function() {
    it('should create an instance of OrderSourceReservation', function() {
      // uncomment below and update the code to test OrderSourceReservation
      //var instane = new infoplus.OrderSourceReservation();
      //expect(instance).to.be.a(infoplus.OrderSourceReservation);
    });
