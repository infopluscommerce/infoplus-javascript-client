...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.ItemCategory();
  });
  ...
  describe('ItemCategory', function() {
    it('should create an instance of ItemCategory', function() {
      // uncomment below and update the code to test ItemCategory
      //var instane = new infoplus.ItemCategory();
      //expect(instance).to.be.a(infoplus.ItemCategory);
    });
