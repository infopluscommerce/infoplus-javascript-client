...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.InventorySnapshot();
  });
  ...
  describe('InventorySnapshot', function() {
    it('should create an instance of InventorySnapshot', function() {
      // uncomment below and update the code to test InventorySnapshot
      //var instane = new infoplus.InventorySnapshot();
      //expect(instance).to.be.a(infoplus.InventorySnapshot);
    });
