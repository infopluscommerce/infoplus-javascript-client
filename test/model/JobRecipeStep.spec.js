...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.JobRecipeStep();
  });
  ...
  describe('JobRecipeStep', function() {
    it('should create an instance of JobRecipeStep', function() {
      // uncomment below and update the code to test JobRecipeStep
      //var instane = new infoplus.JobRecipeStep();
      //expect(instance).to.be.a(infoplus.JobRecipeStep);
    });
