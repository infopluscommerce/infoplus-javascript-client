...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.ItemSector();
  });
  ...
  describe('ItemSector', function() {
    it('should create an instance of ItemSector', function() {
      // uncomment below and update the code to test ItemSector
      //var instane = new infoplus.ItemSector();
      //expect(instance).to.be.a(infoplus.ItemSector);
    });
