...
(function(root, factory) {
  ...
  describe('CartonActivity', function() {
    ...
    it('should have the property cartonAbbr (base name: "cartonAbbr")', function() {
      // uncomment below and update the code to test the property cartonAbbr
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property cartonName (base name: "cartonName")', function() {
      // uncomment below and update the code to test the property cartonName
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cartonInnerLength (base name: "cartonInnerLength")', function() {
      // uncomment below and update the code to test the property cartonInnerLength
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property cartonInnerWidth (base name: "cartonInnerWidth")', function() {
      // uncomment below and update the code to test the property cartonInnerWidth
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property cartonInnerHeight (base name: "cartonInnerHeight")', function() {
      // uncomment below and update the code to test the property cartonInnerHeight
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property cartonWeight (base name: "cartonWeight")', function() {
      // uncomment below and update the code to test the property cartonWeight
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property predefinedCartonId (base name: "predefinedCartonId")', function() {
      // uncomment below and update the code to test the property predefinedCartonId
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });

    it('should have the property predefinedCartonLabel (base name: "predefinedCartonLabel")', function() {
      // uncomment below and update the code to test the property predefinedCartonLabel
      //var instane = new infoplus.CartonActivity();
      //expect(instance).to.be();
    });
