...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new infoplus.PackingPlan();
  });
  ...
  describe('PackingPlan', function() {
    it('should create an instance of PackingPlan', function() {
      // uncomment below and update the code to test PackingPlan
      //var instane = new infoplus.PackingPlan();
      //expect(instance).to.be.a(infoplus.PackingPlan);
    });
