...
var workActivityId = 56; // Number | Id of the workActivity to add an file to
...
apiInstance.addWorkActivityFileByURL(body, workActivityId, callback);
```
 ...
 **workActivityId** | **Number**| Id of the workActivity to add an file to | 
...
var workActivityId = 56; // Number | Id of the workActivity to remove file from
...
apiInstance.deleteWorkActivityFile(workActivityId, fileId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **workActivityId** | **Number**| Id of the workActivity to remove file from | 
...
var workActivityId = 56; // Number | Id of the workActivity to get files for
...
apiInstance.getWorkActivityFiles(workActivityId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **workActivityId** | **Number**| Id of the workActivity to get files for | 
