...
var parcelAccountId = 56; // {Integer} Id of the parcelAccount to add an audit to
...
api.addParcelAccountAudit(parcelAccountId, parcelAccountAudit, callback);
```
...
var parcelAccountId = 56; // {Integer} Id of the parcelAccount to add a tag to
...
api.addParcelAccountTag(parcelAccountId, parcelAccountTag, callback);
```
...
var parcelAccountId = 56; // {Integer} Id of the parcelAccount to remove tag from
...
api.deleteParcelAccountTag(parcelAccountId, parcelAccountTag, callback);
```
...
var parcelAccountId = 56; // {Integer} Id of the parcelAccount to get tags for
...
api.getParcelAccountTags(parcelAccountId, callback);
```
