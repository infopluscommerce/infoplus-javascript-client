...
var quickAdjustmentId = 56; // Number | Id of the quickAdjustment to add a file to
...
apiInstance.addQuickAdjustmentFile(quickAdjustmentId, fileName, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **quickAdjustmentId** | **Number**| Id of the quickAdjustment to add a file to | 
...
var quickAdjustmentId = 56; // Number | Id of the quickAdjustment to add an file to
...
apiInstance.addQuickAdjustmentFileByURL(body, quickAdjustmentId, callback);
```
 ...
 **quickAdjustmentId** | **Number**| Id of the quickAdjustment to add an file to | 
...
var quickAdjustmentId = 56; // Number | Id of the quickAdjustment to remove file from
...
apiInstance.deleteQuickAdjustmentFile(quickAdjustmentId, fileId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **quickAdjustmentId** | **Number**| Id of the quickAdjustment to remove file from | 
...
var quickAdjustmentId = 56; // Number | Id of the quickAdjustment to get files for
...
apiInstance.getQuickAdjustmentFiles(quickAdjustmentId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **quickAdjustmentId** | **Number**| Id of the quickAdjustment to get files for | 
