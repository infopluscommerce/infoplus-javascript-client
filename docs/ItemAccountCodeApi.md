...
> [ItemAccountCode] getItemAccountCodeBySearchText(opts)
...
api.getItemAccountCodeBySearchText(opts, callback);
```
...
> ItemAccountCode getTranslateAccountCodeById(itemAccountCodeId)
...
api.getTranslateAccountCodeById(itemAccountCodeId, callback);
```
