...
<a name="closeAsn"></a>
# **closeAsn**
> [ProcessOutputAPIModel] closeAsn(body)
...
var body = new infoplus.ClosePurchProcessInputAPIModel(); // ClosePurchProcessInputAPIModel | Input data for ClosePurchProcess process.
...
apiInstance.closeAsn(body, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ClosePurchProcessInputAPIModel**](ClosePurchProcessInputAPIModel.md)| Input data for ClosePurchProcess process. | 
