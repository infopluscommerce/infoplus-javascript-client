...
var body = new infoplus.FinanceSystemConnectionLog(); // FinanceSystemConnectionLog | FinanceSystemConnectionLog to be inserted.
...
apiInstance.addFinanceSystemConnectionLog(body, callback);
```
...
var financeSystemConnectionLogId = 56; // Number | Id of the financeSystemConnectionLog to be deleted.
...
apiInstance.deleteFinanceSystemConnectionLog(financeSystemConnectionLogId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **financeSystemConnectionLogId** | **Number**| Id of the financeSystemConnectionLog to be deleted. | 
...
var body = new infoplus.FinanceSystemConnectionLog(); // FinanceSystemConnectionLog | FinanceSystemConnectionLog to be updated.
...
apiInstance.updateFinanceSystemConnectionLog(body, callback);
```
