...
var apiInstance = new infoplus.ItemActivityTypeApi();
...
apiInstance.getItemActivityTypeById(itemActivityTypeId, callback);
```
...
> [ItemActivityType] getItemActivityTypeBySearchText(opts)
...
apiInstance.getItemActivityTypeBySearchText(opts, callback);
```
