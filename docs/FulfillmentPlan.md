...
**selectAlternatePickLocation** | **Boolean** |  | [optional] [default to false]
**autoCreateCycleCountWork** | **Boolean** |  | [optional] [default to false]
**autoAdjustmentTolerance** | **Number** |  | [optional] 
