...
var apiInstance = new infoplus.DasFeeTypeApi();
...
apiInstance.getDASFeeTypeById(dasFeeTypeId, callback);
```
...
> [DasFeeType] getDasFeeTypeBySearchText(opts)
...
apiInstance.getDasFeeTypeBySearchText(opts, callback);
```
