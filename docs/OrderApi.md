...
var orderId = 8.14; // Number | Id of the order to add an file to
...
apiInstance.addOrderFileByURL(body, orderId, callback);
```
 ...
 **orderId** | **Number**| Id of the order to add an file to | 
...
var orderId = 8.14; // Number | Id of the order to remove file from
...
apiInstance.deleteOrderFile(orderId, fileId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | **Number**| Id of the order to remove file from | 
...
var orderId = 8.14; // Number | Id of the order to get files for
...
apiInstance.getOrderFiles(orderId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | **Number**| Id of the order to get files for | 
...
var body = new infoplus.GetOrderPackDataInput(); // GetOrderPackDataInput | Input data for Get Order Pack Data process.
...
apiInstance.getOrderPackData(body, callback);
```
