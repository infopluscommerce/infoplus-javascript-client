...
var shipmentId = 56; // {Integer} Id of the shipment to add an audit to
...
api.addShipmentAudit(shipmentId, shipmentAudit, callback);
```
...
var shipmentId = 56; // {Integer} Id of the shipment to add a tag to
...
api.addShipmentTag(shipmentId, shipmentTag, callback);
```
...
var shipmentId = 56; // {Integer} Id of the shipment to remove tag from
...
api.deleteShipmentTag(shipmentId, shipmentTag, callback);
```
...
var shipmentId = 56; // {Integer} Id of the shipment to be duplicated.
...
api.getDuplicateShipmentById(shipmentId, callback);
```
...
api.getShipmentByFilter(opts, callback);
```
...
var shipmentId = 56; // {Integer} Id of the shipment to be returned.
...
api.getShipmentById(shipmentId, callback);
```
...
var shipmentId = 56; // {Integer} Id of the shipment to get tags for
...
api.getShipmentTags(shipmentId, callback);
```
...
api.updateShipmentCustomFields(body, callback);
```
