...
var replenishmentPlanId = 56; // Number | Id of the replenishmentPlan to add an file to
...
apiInstance.addReplenishmentPlanFileByURL(body, replenishmentPlanId, callback);
```
 ...
 **replenishmentPlanId** | **Number**| Id of the replenishmentPlan to add an file to | 
...
var replenishmentPlanId = 56; // Number | Id of the replenishmentPlan to remove file from
...
apiInstance.deleteReplenishmentPlanFile(replenishmentPlanId, fileId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **replenishmentPlanId** | **Number**| Id of the replenishmentPlan to remove file from | 
...
var replenishmentPlanId = 56; // Number | Id of the replenishmentPlan to get files for
...
apiInstance.getReplenishmentPlanFiles(replenishmentPlanId, callback);
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **replenishmentPlanId** | **Number**| Id of the replenishmentPlan to get files for | 
