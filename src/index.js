(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['./ApiClient', './model/Aisle', './model/Alert', './model/ApiResponse', './model/ApplyOrderWarehouseFulfillmentPlanInput', './model/ApplyOrderWarehouseFulfillmentPlanOutput', './model/Asn', './model/BillOfLading', './model/BillOfLadingCarrierInfoLine', './model/BillOfLadingOrderInfoLine', './model/BillingCode', './model/BillingCodeActivity', './model/BillingCodeType', './model/Building', './model/BusinessTransaction', './model/Carrier', './model/CarrierService', './model/Carton', './model/CartonActivity', './model/CartonContent', './model/CartonType', './model/Customer', './model/CustomerInvoiceTemplate', './model/CustomerInvoiceTemplateLine', './model/EDIDocumentType', './model/EmailTemplate', './model/ExecuteQuickAdjustmentInputAPIModel', './model/ExecuteQuickReceiptInputAPIModel', './model/ExternalShipment', './model/ExternalShippingSystem', './model/FulfillmentPlan', './model/FulfillmentProcess', './model/GetOrderWarehouseFulfillmentDataInput', './model/GetOrderWarehouseFulfillmentDataOutput', './model/IntegrationPartner', './model/InventoryAdjustment', './model/InventoryDetail', './model/InventorySnapshot', './model/InventoryStorageActivity', './model/InvoiceWorksheet', './model/InvoiceWorksheetLine', './model/Item', './model/ItemAccountCode', './model/ItemActivityType', './model/ItemBuyer', './model/ItemCategory', './model/ItemLowstockCode', './model/ItemProductCode', './model/ItemReceipt', './model/ItemReceiptActivity', './model/ItemSector', './model/ItemSubCategory', './model/ItemSummaryCode', './model/JobTime', './model/JobTimeActivity', './model/JobType', './model/Kit', './model/KitComponent', './model/LegacyLowstockContact', './model/LineOfBusiness', './model/Location', './model/LocationAddressScheme', './model/LocationBillingType', './model/LocationFootprint', './model/LoggedTime', './model/LoggedTimeType', './model/LowStock', './model/ManageScheduledPlans', './model/Order', './model/OrderActivity', './model/OrderExtraLineItemData', './model/OrderExtraOrderData', './model/OrderInvoiceTemplateLineItemDescriptionEnum', './model/OrderLine', './model/OrderLineActivity', './model/OrderLoadProgram', './model/OrderSource', './model/OrderSourceReservation', './model/OrderWarehouseFulfillmentPlan', './model/OrderWarehouseFulfillmentPlanDetail', './model/OrderWarehouseFulfillmentRawData', './model/OrderWarehouseFulfillmentRawSkuData', './model/OverrideReturnAddress', './model/PackingSlipTemplateLineItemDescriptionEnum', './model/ParcelAccount', './model/ParcelInvoice', './model/ParcelInvoiceLine', './model/PerpetualInventoryLog', './model/PickFaceAssignment', './model/PredefinedCarton', './model/ProcessOutputAPIModel', './model/ProductType', './model/ProductionLot', './model/QuickAdjustment', './model/QuickReceipt', './model/ReceivingProcess', './model/ReceivingWorksheet', './model/ReceivingWorksheetLineItem', './model/ReceivingWorksheetPutAwayPlan', './model/Replenishment', './model/ReplenishmentPlan', './model/ReplenishmentProcess', './model/ScheduledPlanLog', './model/ServiceType', './model/Shipment', './model/ShoppingCartConnection', './model/Substitution', './model/Supplement', './model/ThirdPartyParcelAccount', './model/User', './model/Vendor', './model/VendorComplianceSurvey', './model/Warehouse', './model/WarehouseDocument', './model/WarehouseDocumentType', './model/Work', './model/WorkActivity', './model/WorkBatch', './model/Zone', './api/AisleApi', './api/AlertApi', './api/AsnApi', './api/BillOfLadingApi', './api/BillingCodeApi', './api/BillingCodeActivityApi', './api/BillingCodeTypeApi', './api/BuildingApi', './api/BusinessTransactionApi', './api/CarrierApi', './api/CarrierServiceApi', './api/CartonApi', './api/CartonActivityApi', './api/CartonContentApi', './api/CartonTypeApi', './api/CustomerApi', './api/CustomerInvoiceTemplateApi', './api/CustomerInvoiceTemplateLineApi', './api/EDIDocumentTypeApi', './api/EmailTemplateApi', './api/ExternalShipmentApi', './api/ExternalShippingSystemApi', './api/FulfillmentPlanApi', './api/FulfillmentProcessApi', './api/IntegrationPartnerApi', './api/InventoryAdjustmentApi', './api/InventoryDetailApi', './api/InventorySnapshotApi', './api/InventoryStorageActivityApi', './api/InvoiceWorksheetApi', './api/InvoiceWorksheetLineApi', './api/ItemApi', './api/ItemAccountCodeApi', './api/ItemActivityTypeApi', './api/ItemBuyerApi', './api/ItemCategoryApi', './api/ItemLowstockCodeApi', './api/ItemProductCodeApi', './api/ItemReceiptApi', './api/ItemReceiptActivityApi', './api/ItemSectorApi', './api/ItemSubCategoryApi', './api/ItemSummaryCodeApi', './api/JobTimeApi', './api/JobTimeActivityApi', './api/JobTypeApi', './api/KitApi', './api/LegacyLowstockContactApi', './api/LineOfBusinessApi', './api/LocationApi', './api/LocationAddressSchemeApi', './api/LocationBillingTypeApi', './api/LocationFootprintApi', './api/LoggedTimeApi', './api/LoggedTimeTypeApi', './api/LowStockApi', './api/ManageScheduledPlansApi', './api/OrderApi', './api/OrderActivityApi', './api/OrderInvoiceTemplateLineItemDescriptionEnumApi', './api/OrderLineApi', './api/OrderLineActivityApi', './api/OrderLoadProgramApi', './api/OrderSourceApi', './api/OrderSourceReservationApi', './api/OverrideReturnAddressApi', './api/PackingSlipTemplateLineItemDescriptionEnumApi', './api/ParcelAccountApi', './api/ParcelInvoiceApi', './api/ParcelInvoiceLineApi', './api/PerpetualInventoryLogApi', './api/PickFaceAssignmentApi', './api/PredefinedCartonApi', './api/ProductTypeApi', './api/ProductionLotApi', './api/QuickAdjustmentApi', './api/QuickReceiptApi', './api/ReceivingProcessApi', './api/ReceivingWorksheetApi', './api/ReplenishmentApi', './api/ReplenishmentPlanApi', './api/ReplenishmentProcessApi', './api/ScheduledPlanLogApi', './api/ServiceTypeApi', './api/ShipmentApi', './api/ShoppingCartConnectionApi', './api/SubstitutionApi', './api/SupplementApi', './api/ThirdPartyParcelAccountApi', './api/UserApi', './api/VendorApi', './api/VendorComplianceSurveyApi', './api/WarehouseApi', './api/WarehouseDocumentApi', './api/WarehouseDocumentTypeApi', './api/WorkApi', './api/WorkActivityApi', './api/WorkBatchApi', './api/ZoneApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Aisle'), require('./model/Alert'), require('./model/ApiResponse'), require('./model/ApplyOrderWarehouseFulfillmentPlanInput'), require('./model/ApplyOrderWarehouseFulfillmentPlanOutput'), require('./model/Asn'), require('./model/BillOfLading'), require('./model/BillOfLadingCarrierInfoLine'), require('./model/BillOfLadingOrderInfoLine'), require('./model/BillingCode'), require('./model/BillingCodeActivity'), require('./model/BillingCodeType'), require('./model/Building'), require('./model/BusinessTransaction'), require('./model/Carrier'), require('./model/CarrierService'), require('./model/Carton'), require('./model/CartonActivity'), require('./model/CartonContent'), require('./model/CartonType'), require('./model/Customer'), require('./model/CustomerInvoiceTemplate'), require('./model/CustomerInvoiceTemplateLine'), require('./model/EDIDocumentType'), require('./model/EmailTemplate'), require('./model/ExecuteQuickAdjustmentInputAPIModel'), require('./model/ExecuteQuickReceiptInputAPIModel'), require('./model/ExternalShipment'), require('./model/ExternalShippingSystem'), require('./model/FulfillmentPlan'), require('./model/FulfillmentProcess'), require('./model/GetOrderWarehouseFulfillmentDataInput'), require('./model/GetOrderWarehouseFulfillmentDataOutput'), require('./model/IntegrationPartner'), require('./model/InventoryAdjustment'), require('./model/InventoryDetail'), require('./model/InventorySnapshot'), require('./model/InventoryStorageActivity'), require('./model/InvoiceWorksheet'), require('./model/InvoiceWorksheetLine'), require('./model/Item'), require('./model/ItemAccountCode'), require('./model/ItemActivityType'), require('./model/ItemBuyer'), require('./model/ItemCategory'), require('./model/ItemLowstockCode'), require('./model/ItemProductCode'), require('./model/ItemReceipt'), require('./model/ItemReceiptActivity'), require('./model/ItemSector'), require('./model/ItemSubCategory'), require('./model/ItemSummaryCode'), require('./model/JobTime'), require('./model/JobTimeActivity'), require('./model/JobType'), require('./model/Kit'), require('./model/KitComponent'), require('./model/LegacyLowstockContact'), require('./model/LineOfBusiness'), require('./model/Location'), require('./model/LocationAddressScheme'), require('./model/LocationBillingType'), require('./model/LocationFootprint'), require('./model/LoggedTime'), require('./model/LoggedTimeType'), require('./model/LowStock'), require('./model/ManageScheduledPlans'), require('./model/Order'), require('./model/OrderActivity'), require('./model/OrderExtraLineItemData'), require('./model/OrderExtraOrderData'), require('./model/OrderInvoiceTemplateLineItemDescriptionEnum'), require('./model/OrderLine'), require('./model/OrderLineActivity'), require('./model/OrderLoadProgram'), require('./model/OrderSource'), require('./model/OrderSourceReservation'), require('./model/OrderWarehouseFulfillmentPlan'), require('./model/OrderWarehouseFulfillmentPlanDetail'), require('./model/OrderWarehouseFulfillmentRawData'), require('./model/OrderWarehouseFulfillmentRawSkuData'), require('./model/OverrideReturnAddress'), require('./model/PackingSlipTemplateLineItemDescriptionEnum'), require('./model/ParcelAccount'), require('./model/ParcelInvoice'), require('./model/ParcelInvoiceLine'), require('./model/PerpetualInventoryLog'), require('./model/PickFaceAssignment'), require('./model/PredefinedCarton'), require('./model/ProcessOutputAPIModel'), require('./model/ProductType'), require('./model/ProductionLot'), require('./model/QuickAdjustment'), require('./model/QuickReceipt'), require('./model/ReceivingProcess'), require('./model/ReceivingWorksheet'), require('./model/ReceivingWorksheetLineItem'), require('./model/ReceivingWorksheetPutAwayPlan'), require('./model/Replenishment'), require('./model/ReplenishmentPlan'), require('./model/ReplenishmentProcess'), require('./model/ScheduledPlanLog'), require('./model/ServiceType'), require('./model/Shipment'), require('./model/ShoppingCartConnection'), require('./model/Substitution'), require('./model/Supplement'), require('./model/ThirdPartyParcelAccount'), require('./model/User'), require('./model/Vendor'), require('./model/VendorComplianceSurvey'), require('./model/Warehouse'), require('./model/WarehouseDocument'), require('./model/WarehouseDocumentType'), require('./model/Work'), require('./model/WorkActivity'), require('./model/WorkBatch'), require('./model/Zone'), require('./api/AisleApi'), require('./api/AlertApi'), require('./api/AsnApi'), require('./api/BillOfLadingApi'), require('./api/BillingCodeApi'), require('./api/BillingCodeActivityApi'), require('./api/BillingCodeTypeApi'), require('./api/BuildingApi'), require('./api/BusinessTransactionApi'), require('./api/CarrierApi'), require('./api/CarrierServiceApi'), require('./api/CartonApi'), require('./api/CartonActivityApi'), require('./api/CartonContentApi'), require('./api/CartonTypeApi'), require('./api/CustomerApi'), require('./api/CustomerInvoiceTemplateApi'), require('./api/CustomerInvoiceTemplateLineApi'), require('./api/EDIDocumentTypeApi'), require('./api/EmailTemplateApi'), require('./api/ExternalShipmentApi'), require('./api/ExternalShippingSystemApi'), require('./api/FulfillmentPlanApi'), require('./api/FulfillmentProcessApi'), require('./api/IntegrationPartnerApi'), require('./api/InventoryAdjustmentApi'), require('./api/InventoryDetailApi'), require('./api/InventorySnapshotApi'), require('./api/InventoryStorageActivityApi'), require('./api/InvoiceWorksheetApi'), require('./api/InvoiceWorksheetLineApi'), require('./api/ItemApi'), require('./api/ItemAccountCodeApi'), require('./api/ItemActivityTypeApi'), require('./api/ItemBuyerApi'), require('./api/ItemCategoryApi'), require('./api/ItemLowstockCodeApi'), require('./api/ItemProductCodeApi'), require('./api/ItemReceiptApi'), require('./api/ItemReceiptActivityApi'), require('./api/ItemSectorApi'), require('./api/ItemSubCategoryApi'), require('./api/ItemSummaryCodeApi'), require('./api/JobTimeApi'), require('./api/JobTimeActivityApi'), require('./api/JobTypeApi'), require('./api/KitApi'), require('./api/LegacyLowstockContactApi'), require('./api/LineOfBusinessApi'), require('./api/LocationApi'), require('./api/LocationAddressSchemeApi'), require('./api/LocationBillingTypeApi'), require('./api/LocationFootprintApi'), require('./api/LoggedTimeApi'), require('./api/LoggedTimeTypeApi'), require('./api/LowStockApi'), require('./api/ManageScheduledPlansApi'), require('./api/OrderApi'), require('./api/OrderActivityApi'), require('./api/OrderInvoiceTemplateLineItemDescriptionEnumApi'), require('./api/OrderLineApi'), require('./api/OrderLineActivityApi'), require('./api/OrderLoadProgramApi'), require('./api/OrderSourceApi'), require('./api/OrderSourceReservationApi'), require('./api/OverrideReturnAddressApi'), require('./api/PackingSlipTemplateLineItemDescriptionEnumApi'), require('./api/ParcelAccountApi'), require('./api/ParcelInvoiceApi'), require('./api/ParcelInvoiceLineApi'), require('./api/PerpetualInventoryLogApi'), require('./api/PickFaceAssignmentApi'), require('./api/PredefinedCartonApi'), require('./api/ProductTypeApi'), require('./api/ProductionLotApi'), require('./api/QuickAdjustmentApi'), require('./api/QuickReceiptApi'), require('./api/ReceivingProcessApi'), require('./api/ReceivingWorksheetApi'), require('./api/ReplenishmentApi'), require('./api/ReplenishmentPlanApi'), require('./api/ReplenishmentProcessApi'), require('./api/ScheduledPlanLogApi'), require('./api/ServiceTypeApi'), require('./api/ShipmentApi'), require('./api/ShoppingCartConnectionApi'), require('./api/SubstitutionApi'), require('./api/SupplementApi'), require('./api/ThirdPartyParcelAccountApi'), require('./api/UserApi'), require('./api/VendorApi'), require('./api/VendorComplianceSurveyApi'), require('./api/WarehouseApi'), require('./api/WarehouseDocumentApi'), require('./api/WarehouseDocumentTypeApi'), require('./api/WorkApi'), require('./api/WorkActivityApi'), require('./api/WorkBatchApi'), require('./api/ZoneApi'));
  }
}(function(ApiClient, Aisle, Alert, ApiResponse, ApplyOrderWarehouseFulfillmentPlanInput, ApplyOrderWarehouseFulfillmentPlanOutput, Asn, BillOfLading, BillOfLadingCarrierInfoLine, BillOfLadingOrderInfoLine, BillingCode, BillingCodeActivity, BillingCodeType, Building, BusinessTransaction, Carrier, CarrierService, Carton, CartonActivity, CartonContent, CartonType, Customer, CustomerInvoiceTemplate, CustomerInvoiceTemplateLine, EDIDocumentType, EmailTemplate, ExecuteQuickAdjustmentInputAPIModel, ExecuteQuickReceiptInputAPIModel, ExternalShipment, ExternalShippingSystem, FulfillmentPlan, FulfillmentProcess, GetOrderWarehouseFulfillmentDataInput, GetOrderWarehouseFulfillmentDataOutput, IntegrationPartner, InventoryAdjustment, InventoryDetail, InventorySnapshot, InventoryStorageActivity, InvoiceWorksheet, InvoiceWorksheetLine, Item, ItemAccountCode, ItemActivityType, ItemBuyer, ItemCategory, ItemLowstockCode, ItemProductCode, ItemReceipt, ItemReceiptActivity, ItemSector, ItemSubCategory, ItemSummaryCode, JobTime, JobTimeActivity, JobType, Kit, KitComponent, LegacyLowstockContact, LineOfBusiness, Location, LocationAddressScheme, LocationBillingType, LocationFootprint, LoggedTime, LoggedTimeType, LowStock, ManageScheduledPlans, Order, OrderActivity, OrderExtraLineItemData, OrderExtraOrderData, OrderInvoiceTemplateLineItemDescriptionEnum, OrderLine, OrderLineActivity, OrderLoadProgram, OrderSource, OrderSourceReservation, OrderWarehouseFulfillmentPlan, OrderWarehouseFulfillmentPlanDetail, OrderWarehouseFulfillmentRawData, OrderWarehouseFulfillmentRawSkuData, OverrideReturnAddress, PackingSlipTemplateLineItemDescriptionEnum, ParcelAccount, ParcelInvoice, ParcelInvoiceLine, PerpetualInventoryLog, PickFaceAssignment, PredefinedCarton, ProcessOutputAPIModel, ProductType, ProductionLot, QuickAdjustment, QuickReceipt, ReceivingProcess, ReceivingWorksheet, ReceivingWorksheetLineItem, ReceivingWorksheetPutAwayPlan, Replenishment, ReplenishmentPlan, ReplenishmentProcess, ScheduledPlanLog, ServiceType, Shipment, ShoppingCartConnection, Substitution, Supplement, ThirdPartyParcelAccount, User, Vendor, VendorComplianceSurvey, Warehouse, WarehouseDocument, WarehouseDocumentType, Work, WorkActivity, WorkBatch, Zone, AisleApi, AlertApi, AsnApi, BillOfLadingApi, BillingCodeApi, BillingCodeActivityApi, BillingCodeTypeApi, BuildingApi, BusinessTransactionApi, CarrierApi, CarrierServiceApi, CartonApi, CartonActivityApi, CartonContentApi, CartonTypeApi, CustomerApi, CustomerInvoiceTemplateApi, CustomerInvoiceTemplateLineApi, EDIDocumentTypeApi, EmailTemplateApi, ExternalShipmentApi, ExternalShippingSystemApi, FulfillmentPlanApi, FulfillmentProcessApi, IntegrationPartnerApi, InventoryAdjustmentApi, InventoryDetailApi, InventorySnapshotApi, InventoryStorageActivityApi, InvoiceWorksheetApi, InvoiceWorksheetLineApi, ItemApi, ItemAccountCodeApi, ItemActivityTypeApi, ItemBuyerApi, ItemCategoryApi, ItemLowstockCodeApi, ItemProductCodeApi, ItemReceiptApi, ItemReceiptActivityApi, ItemSectorApi, ItemSubCategoryApi, ItemSummaryCodeApi, JobTimeApi, JobTimeActivityApi, JobTypeApi, KitApi, LegacyLowstockContactApi, LineOfBusinessApi, LocationApi, LocationAddressSchemeApi, LocationBillingTypeApi, LocationFootprintApi, LoggedTimeApi, LoggedTimeTypeApi, LowStockApi, ManageScheduledPlansApi, OrderApi, OrderActivityApi, OrderInvoiceTemplateLineItemDescriptionEnumApi, OrderLineApi, OrderLineActivityApi, OrderLoadProgramApi, OrderSourceApi, OrderSourceReservationApi, OverrideReturnAddressApi, PackingSlipTemplateLineItemDescriptionEnumApi, ParcelAccountApi, ParcelInvoiceApi, ParcelInvoiceLineApi, PerpetualInventoryLogApi, PickFaceAssignmentApi, PredefinedCartonApi, ProductTypeApi, ProductionLotApi, QuickAdjustmentApi, QuickReceiptApi, ReceivingProcessApi, ReceivingWorksheetApi, ReplenishmentApi, ReplenishmentPlanApi, ReplenishmentProcessApi, ScheduledPlanLogApi, ServiceTypeApi, ShipmentApi, ShoppingCartConnectionApi, SubstitutionApi, SupplementApi, ThirdPartyParcelAccountApi, UserApi, VendorApi, VendorComplianceSurveyApi, WarehouseApi, WarehouseDocumentApi, WarehouseDocumentTypeApi, WorkApi, WorkActivityApi, WorkBatchApi, ZoneApi) {
  'use strict';
