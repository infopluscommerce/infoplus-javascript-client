(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['./ApiClient', './model/Aisle', './model/Alert', './model/ApiResponse', './model/Asn', './model/BillOfLading', './model/BillOfLadingCarrierInfoLine', './model/BillOfLadingOrderInfoLine', './model/BillingCode', './model/BillingCodeType', './model/Building', './model/BusinessTransaction', './model/Carrier', './model/CarrierService', './model/Carton', './model/CartonContent', './model/CartonType', './model/Customer', './model/EmailTemplate', './model/ExternalShipment', './model/ExternalShippingSystem', './model/FulfillmentPlan', './model/FulfillmentProcess', './model/IntegrationPartner', './model/InventoryAdjustment', './model/InventoryDetail', './model/Item', './model/ItemAccountCode', './model/ItemActivityType', './model/ItemBuyer', './model/ItemCategory', './model/ItemLowstockCode', './model/ItemProductCode', './model/ItemReceipt', './model/ItemSector', './model/ItemSubCategory', './model/ItemSummaryCode', './model/JobTime', './model/JobType', './model/Kit', './model/LegacyLowstockContact', './model/LineOfBusiness', './model/Location', './model/LocationAddressScheme', './model/LocationBillingType', './model/LocationFootprint', './model/LoggedTime', './model/LoggedTimeType', './model/LowStock', './model/ManageScheduledPlans', './model/Order', './model/OrderExtraLineItemData', './model/OrderExtraOrderData', './model/OrderLine', './model/OrderLoadProgram', './model/OrderSource', './model/OrderSourceReservation', './model/OverrideReturnAddress', './model/ParcelAccount', './model/ParcelShipment', './model/PickFaceAssignment', './model/ProductType', './model/ProductionLot', './model/QuickAdjustment', './model/QuickReceipt', './model/ReceivingProcess', './model/ReceivingWorksheet', './model/ReceivingWorksheetLineItem', './model/ReceivingWorksheetPutAwayPlan', './model/Replenishment', './model/ReplenishmentPlan', './model/ReplenishmentProcess', './model/ScheduledPlanLog', './model/ServiceType', './model/ShoppingCartConnection', './model/Substitution', './model/Supplement', './model/ThirdPartyParcelAccount', './model/User', './model/Vendor', './model/VendorComplianceSurvey', './model/Warehouse', './model/WarehouseDocument', './model/WarehouseDocumentType', './model/Work', './model/WorkBatch', './model/Zone', './api/AisleApi', './api/AlertApi', './api/AsnApi', './api/BillOfLadingApi', './api/BillingCodeApi', './api/BillingCodeTypeApi', './api/BuildingApi', './api/BusinessTransactionApi', './api/CarrierApi', './api/CarrierServiceApi', './api/CartonApi', './api/CartonContentApi', './api/CartonTypeApi', './api/CustomerApi', './api/EmailTemplateApi', './api/ExternalShipmentApi', './api/ExternalShippingSystemApi', './api/FulfillmentPlanApi', './api/FulfillmentProcessApi', './api/IntegrationPartnerApi', './api/InventoryAdjustmentApi', './api/InventoryDetailApi', './api/ItemApi', './api/ItemAccountCodeApi', './api/ItemActivityTypeApi', './api/ItemBuyerApi', './api/ItemCategoryApi', './api/ItemLowstockCodeApi', './api/ItemProductCodeApi', './api/ItemReceiptApi', './api/ItemSectorApi', './api/ItemSubCategoryApi', './api/ItemSummaryCodeApi', './api/JobTimeApi', './api/JobTypeApi', './api/KitApi', './api/LegacyLowstockContactApi', './api/LineOfBusinessApi', './api/LocationApi', './api/LocationAddressSchemeApi', './api/LocationBillingTypeApi', './api/LocationFootprintApi', './api/LoggedTimeApi', './api/LoggedTimeTypeApi', './api/LowStockApi', './api/ManageScheduledPlansApi', './api/OrderApi', './api/OrderLineApi', './api/OrderLoadProgramApi', './api/OrderSourceApi', './api/OrderSourceReservationApi', './api/OverrideReturnAddressApi', './api/ParcelAccountApi', './api/ParcelShipmentApi', './api/PickFaceAssignmentApi', './api/ProductTypeApi', './api/ProductionLotApi', './api/QuickAdjustmentApi', './api/QuickReceiptApi', './api/ReceivingProcessApi', './api/ReceivingWorksheetApi', './api/ReplenishmentApi', './api/ReplenishmentPlanApi', './api/ReplenishmentProcessApi', './api/ScheduledPlanLogApi', './api/ServiceTypeApi', './api/ShoppingCartConnectionApi', './api/SubstitutionApi', './api/SupplementApi', './api/ThirdPartyParcelAccountApi', './api/UserApi', './api/VendorApi', './api/VendorComplianceSurveyApi', './api/WarehouseApi', './api/WarehouseDocumentApi', './api/WarehouseDocumentTypeApi', './api/WorkApi', './api/WorkBatchApi', './api/ZoneApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Aisle'), require('./model/Alert'), require('./model/ApiResponse'), require('./model/Asn'), require('./model/BillOfLading'), require('./model/BillOfLadingCarrierInfoLine'), require('./model/BillOfLadingOrderInfoLine'), require('./model/BillingCode'), require('./model/BillingCodeType'), require('./model/Building'), require('./model/BusinessTransaction'), require('./model/Carrier'), require('./model/CarrierService'), require('./model/Carton'), require('./model/CartonContent'), require('./model/CartonType'), require('./model/Customer'), require('./model/EmailTemplate'), require('./model/ExternalShipment'), require('./model/ExternalShippingSystem'), require('./model/FulfillmentPlan'), require('./model/FulfillmentProcess'), require('./model/IntegrationPartner'), require('./model/InventoryAdjustment'), require('./model/InventoryDetail'), require('./model/Item'), require('./model/ItemAccountCode'), require('./model/ItemActivityType'), require('./model/ItemBuyer'), require('./model/ItemCategory'), require('./model/ItemLowstockCode'), require('./model/ItemProductCode'), require('./model/ItemReceipt'), require('./model/ItemSector'), require('./model/ItemSubCategory'), require('./model/ItemSummaryCode'), require('./model/JobTime'), require('./model/JobType'), require('./model/Kit'), require('./model/LegacyLowstockContact'), require('./model/LineOfBusiness'), require('./model/Location'), require('./model/LocationAddressScheme'), require('./model/LocationBillingType'), require('./model/LocationFootprint'), require('./model/LoggedTime'), require('./model/LoggedTimeType'), require('./model/LowStock'), require('./model/ManageScheduledPlans'), require('./model/Order'), require('./model/OrderExtraLineItemData'), require('./model/OrderExtraOrderData'), require('./model/OrderLine'), require('./model/OrderLoadProgram'), require('./model/OrderSource'), require('./model/OrderSourceReservation'), require('./model/OverrideReturnAddress'), require('./model/ParcelAccount'), require('./model/ParcelShipment'), require('./model/PickFaceAssignment'), require('./model/ProductType'), require('./model/ProductionLot'), require('./model/QuickAdjustment'), require('./model/QuickReceipt'), require('./model/ReceivingProcess'), require('./model/ReceivingWorksheet'), require('./model/ReceivingWorksheetLineItem'), require('./model/ReceivingWorksheetPutAwayPlan'), require('./model/Replenishment'), require('./model/ReplenishmentPlan'), require('./model/ReplenishmentProcess'), require('./model/ScheduledPlanLog'), require('./model/ServiceType'), require('./model/ShoppingCartConnection'), require('./model/Substitution'), require('./model/Supplement'), require('./model/ThirdPartyParcelAccount'), require('./model/User'), require('./model/Vendor'), require('./model/VendorComplianceSurvey'), require('./model/Warehouse'), require('./model/WarehouseDocument'), require('./model/WarehouseDocumentType'), require('./model/Work'), require('./model/WorkBatch'), require('./model/Zone'), require('./api/AisleApi'), require('./api/AlertApi'), require('./api/AsnApi'), require('./api/BillOfLadingApi'), require('./api/BillingCodeApi'), require('./api/BillingCodeTypeApi'), require('./api/BuildingApi'), require('./api/BusinessTransactionApi'), require('./api/CarrierApi'), require('./api/CarrierServiceApi'), require('./api/CartonApi'), require('./api/CartonContentApi'), require('./api/CartonTypeApi'), require('./api/CustomerApi'), require('./api/EmailTemplateApi'), require('./api/ExternalShipmentApi'), require('./api/ExternalShippingSystemApi'), require('./api/FulfillmentPlanApi'), require('./api/FulfillmentProcessApi'), require('./api/IntegrationPartnerApi'), require('./api/InventoryAdjustmentApi'), require('./api/InventoryDetailApi'), require('./api/ItemApi'), require('./api/ItemAccountCodeApi'), require('./api/ItemActivityTypeApi'), require('./api/ItemBuyerApi'), require('./api/ItemCategoryApi'), require('./api/ItemLowstockCodeApi'), require('./api/ItemProductCodeApi'), require('./api/ItemReceiptApi'), require('./api/ItemSectorApi'), require('./api/ItemSubCategoryApi'), require('./api/ItemSummaryCodeApi'), require('./api/JobTimeApi'), require('./api/JobTypeApi'), require('./api/KitApi'), require('./api/LegacyLowstockContactApi'), require('./api/LineOfBusinessApi'), require('./api/LocationApi'), require('./api/LocationAddressSchemeApi'), require('./api/LocationBillingTypeApi'), require('./api/LocationFootprintApi'), require('./api/LoggedTimeApi'), require('./api/LoggedTimeTypeApi'), require('./api/LowStockApi'), require('./api/ManageScheduledPlansApi'), require('./api/OrderApi'), require('./api/OrderLineApi'), require('./api/OrderLoadProgramApi'), require('./api/OrderSourceApi'), require('./api/OrderSourceReservationApi'), require('./api/OverrideReturnAddressApi'), require('./api/ParcelAccountApi'), require('./api/ParcelShipmentApi'), require('./api/PickFaceAssignmentApi'), require('./api/ProductTypeApi'), require('./api/ProductionLotApi'), require('./api/QuickAdjustmentApi'), require('./api/QuickReceiptApi'), require('./api/ReceivingProcessApi'), require('./api/ReceivingWorksheetApi'), require('./api/ReplenishmentApi'), require('./api/ReplenishmentPlanApi'), require('./api/ReplenishmentProcessApi'), require('./api/ScheduledPlanLogApi'), require('./api/ServiceTypeApi'), require('./api/ShoppingCartConnectionApi'), require('./api/SubstitutionApi'), require('./api/SupplementApi'), require('./api/ThirdPartyParcelAccountApi'), require('./api/UserApi'), require('./api/VendorApi'), require('./api/VendorComplianceSurveyApi'), require('./api/WarehouseApi'), require('./api/WarehouseDocumentApi'), require('./api/WarehouseDocumentTypeApi'), require('./api/WorkApi'), require('./api/WorkBatchApi'), require('./api/ZoneApi'));
  }
}(function(ApiClient, Aisle, Alert, ApiResponse, Asn, BillOfLading, BillOfLadingCarrierInfoLine, BillOfLadingOrderInfoLine, BillingCode, BillingCodeType, Building, BusinessTransaction, Carrier, CarrierService, Carton, CartonContent, CartonType, Customer, EmailTemplate, ExternalShipment, ExternalShippingSystem, FulfillmentPlan, FulfillmentProcess, IntegrationPartner, InventoryAdjustment, InventoryDetail, Item, ItemAccountCode, ItemActivityType, ItemBuyer, ItemCategory, ItemLowstockCode, ItemProductCode, ItemReceipt, ItemSector, ItemSubCategory, ItemSummaryCode, JobTime, JobType, Kit, LegacyLowstockContact, LineOfBusiness, Location, LocationAddressScheme, LocationBillingType, LocationFootprint, LoggedTime, LoggedTimeType, LowStock, ManageScheduledPlans, Order, OrderExtraLineItemData, OrderExtraOrderData, OrderLine, OrderLoadProgram, OrderSource, OrderSourceReservation, OverrideReturnAddress, ParcelAccount, ParcelShipment, PickFaceAssignment, ProductType, ProductionLot, QuickAdjustment, QuickReceipt, ReceivingProcess, ReceivingWorksheet, ReceivingWorksheetLineItem, ReceivingWorksheetPutAwayPlan, Replenishment, ReplenishmentPlan, ReplenishmentProcess, ScheduledPlanLog, ServiceType, ShoppingCartConnection, Substitution, Supplement, ThirdPartyParcelAccount, User, Vendor, VendorComplianceSurvey, Warehouse, WarehouseDocument, WarehouseDocumentType, Work, WorkBatch, Zone, AisleApi, AlertApi, AsnApi, BillOfLadingApi, BillingCodeApi, BillingCodeTypeApi, BuildingApi, BusinessTransactionApi, CarrierApi, CarrierServiceApi, CartonApi, CartonContentApi, CartonTypeApi, CustomerApi, EmailTemplateApi, ExternalShipmentApi, ExternalShippingSystemApi, FulfillmentPlanApi, FulfillmentProcessApi, IntegrationPartnerApi, InventoryAdjustmentApi, InventoryDetailApi, ItemApi, ItemAccountCodeApi, ItemActivityTypeApi, ItemBuyerApi, ItemCategoryApi, ItemLowstockCodeApi, ItemProductCodeApi, ItemReceiptApi, ItemSectorApi, ItemSubCategoryApi, ItemSummaryCodeApi, JobTimeApi, JobTypeApi, KitApi, LegacyLowstockContactApi, LineOfBusinessApi, LocationApi, LocationAddressSchemeApi, LocationBillingTypeApi, LocationFootprintApi, LoggedTimeApi, LoggedTimeTypeApi, LowStockApi, ManageScheduledPlansApi, OrderApi, OrderLineApi, OrderLoadProgramApi, OrderSourceApi, OrderSourceReservationApi, OverrideReturnAddressApi, ParcelAccountApi, ParcelShipmentApi, PickFaceAssignmentApi, ProductTypeApi, ProductionLotApi, QuickAdjustmentApi, QuickReceiptApi, ReceivingProcessApi, ReceivingWorksheetApi, ReplenishmentApi, ReplenishmentPlanApi, ReplenishmentProcessApi, ScheduledPlanLogApi, ServiceTypeApi, ShoppingCartConnectionApi, SubstitutionApi, SupplementApi, ThirdPartyParcelAccountApi, UserApi, VendorApi, VendorComplianceSurveyApi, WarehouseApi, WarehouseDocumentApi, WarehouseDocumentTypeApi, WorkApi, WorkBatchApi, ZoneApi) {
  'use strict';
