...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('skuTranslation')) {
        obj['skuTranslation'] = ApiClient.convertToType(data['skuTranslation'], 'String');
      }
  ...
  /**
   * @member {String} skuTranslation
   */
  exports.prototype['skuTranslation'] = undefined;
  /**
