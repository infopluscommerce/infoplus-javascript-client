...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('manifestPartnerOrderId')) {
        obj['manifestPartnerOrderId'] = ApiClient.convertToType(data['manifestPartnerOrderId'], 'String');
      }
  ...
  /**
   * @member {String} manifestPartnerOrderId
   */
  exports.prototype['manifestPartnerOrderId'] = undefined;
  /**
