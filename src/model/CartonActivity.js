...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cartonAbbr')) {
        obj['cartonAbbr'] = ApiClient.convertToType(data['cartonAbbr'], 'String');
      }
      if (data.hasOwnProperty('cartonName')) {
        obj['cartonName'] = ApiClient.convertToType(data['cartonName'], 'String');
      }
      ...
      if (data.hasOwnProperty('cartonInnerLength')) {
        obj['cartonInnerLength'] = ApiClient.convertToType(data['cartonInnerLength'], 'Number');
      }
      if (data.hasOwnProperty('cartonInnerWidth')) {
        obj['cartonInnerWidth'] = ApiClient.convertToType(data['cartonInnerWidth'], 'Number');
      }
      if (data.hasOwnProperty('cartonInnerHeight')) {
        obj['cartonInnerHeight'] = ApiClient.convertToType(data['cartonInnerHeight'], 'Number');
      }
      if (data.hasOwnProperty('cartonWeight')) {
        obj['cartonWeight'] = ApiClient.convertToType(data['cartonWeight'], 'Number');
      }
      if (data.hasOwnProperty('predefinedCartonId')) {
        obj['predefinedCartonId'] = ApiClient.convertToType(data['predefinedCartonId'], 'Number');
      }
      if (data.hasOwnProperty('predefinedCartonLabel')) {
        obj['predefinedCartonLabel'] = ApiClient.convertToType(data['predefinedCartonLabel'], 'String');
      }
  ...
  /**
   * @member {String} cartonAbbr
   */
  exports.prototype['cartonAbbr'] = undefined;
  /**
   * @member {String} cartonName
   */
  exports.prototype['cartonName'] = undefined;
  /**
  ...
  /**
   * @member {Number} cartonInnerLength
   */
  exports.prototype['cartonInnerLength'] = undefined;
  /**
   * @member {Number} cartonInnerWidth
   */
  exports.prototype['cartonInnerWidth'] = undefined;
  /**
   * @member {Number} cartonInnerHeight
   */
  exports.prototype['cartonInnerHeight'] = undefined;
  /**
   * @member {Number} cartonWeight
   */
  exports.prototype['cartonWeight'] = undefined;
  /**
   * @member {Number} predefinedCartonId
   */
  exports.prototype['predefinedCartonId'] = undefined;
  /**
   * @member {String} predefinedCartonLabel
   */
  exports.prototype['predefinedCartonLabel'] = undefined;
  /**
