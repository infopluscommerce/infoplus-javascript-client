...
(function(root, factory) {
   ...
   */
  var exports = function(abbreviation, name, lengthIn, widthIn, heightIn, lobId, isActive) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('noOfCavities')) {
        obj['noOfCavities'] = ApiClient.convertToType(data['noOfCavities'], 'Number');
      }
      if (data.hasOwnProperty('materialDescription')) {
        obj['materialDescription'] = ApiClient.convertToType(data['materialDescription'], 'String');
      }
  ...
  /**
   * @member {Number} noOfCavities
   */
  exports.prototype['noOfCavities'] = undefined;
  /**
   * @member {String} materialDescription
   */
  exports.prototype['materialDescription'] = undefined;
  /**
