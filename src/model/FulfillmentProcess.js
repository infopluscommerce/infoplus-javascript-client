...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('workBatchIdList')) {
        obj['workBatchIdList'] = ApiClient.convertToType(data['workBatchIdList'], ['Number']);
      }
      ...
      if (data.hasOwnProperty('selectAlternatePickLocation')) {
        obj['selectAlternatePickLocation'] = ApiClient.convertToType(data['selectAlternatePickLocation'], 'Boolean');
      }
      if (data.hasOwnProperty('firstPickPosition')) {
        obj['firstPickPosition'] = ApiClient.convertToType(data['firstPickPosition'], 'Number');
      }
      if (data.hasOwnProperty('autoCreateCycleCountWork')) {
        obj['autoCreateCycleCountWork'] = ApiClient.convertToType(data['autoCreateCycleCountWork'], 'Boolean');
      }
      if (data.hasOwnProperty('autoAdjustmentTolerance')) {
        obj['autoAdjustmentTolerance'] = ApiClient.convertToType(data['autoAdjustmentTolerance'], 'Number');
      }
  ...
  /**
   * @member {Array.<Number>} workBatchIdList
   */
  exports.prototype['workBatchIdList'] = undefined;
  /**
  ...
  /**
   * @member {Boolean} selectAlternatePickLocation
   * @default false
   */
  exports.prototype['selectAlternatePickLocation'] = false;
  /**
   * @member {Number} firstPickPosition
   */
  exports.prototype['firstPickPosition'] = undefined;
  /**
   * @member {Boolean} autoCreateCycleCountWork
   * @default false
   */
  exports.prototype['autoCreateCycleCountWork'] = false;
  /**
   * @member {Number} autoAdjustmentTolerance
   */
  exports.prototype['autoAdjustmentTolerance'] = undefined;
  /**
