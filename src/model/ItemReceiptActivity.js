...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('receiptUnitsPerInnerPack')) {
        obj['receiptUnitsPerInnerPack'] = ApiClient.convertToType(data['receiptUnitsPerInnerPack'], 'Number');
      }
      ...
      if (data.hasOwnProperty('receiptUnitsPerPallet')) {
        obj['receiptUnitsPerPallet'] = ApiClient.convertToType(data['receiptUnitsPerPallet'], 'Number');
      }
      if (data.hasOwnProperty('receiptVendor')) {
        obj['receiptVendor'] = ApiClient.convertToType(data['receiptVendor'], 'Number');
      }
      ...
      if (data.hasOwnProperty('receiptReceiveQuantity')) {
        obj['receiptReceiveQuantity'] = ApiClient.convertToType(data['receiptReceiveQuantity'], 'Number');
      }
      if (data.hasOwnProperty('receiptNumberOfInnerPack')) {
        obj['receiptNumberOfInnerPack'] = ApiClient.convertToType(data['receiptNumberOfInnerPack'], 'Number');
      }
      if (data.hasOwnProperty('receiptNumberOfCases')) {
        obj['receiptNumberOfCases'] = ApiClient.convertToType(data['receiptNumberOfCases'], 'Number');
      }
      if (data.hasOwnProperty('receiptNumberOfPallets')) {
        obj['receiptNumberOfPallets'] = ApiClient.convertToType(data['receiptNumberOfPallets'], 'Number');
      }
      if (data.hasOwnProperty('receivedNumberOfInnerPack')) {
        obj['receivedNumberOfInnerPack'] = ApiClient.convertToType(data['receivedNumberOfInnerPack'], 'Number');
      }
      if (data.hasOwnProperty('receivedNumberOfCases')) {
        obj['receivedNumberOfCases'] = ApiClient.convertToType(data['receivedNumberOfCases'], 'Number');
      }
      if (data.hasOwnProperty('receivedNumberOfPallets')) {
        obj['receivedNumberOfPallets'] = ApiClient.convertToType(data['receivedNumberOfPallets'], 'Number');
      }
  ...
  /**
   * @member {Number} receiptUnitsPerInnerPack
   */
  exports.prototype['receiptUnitsPerInnerPack'] = undefined;
  /**
   * @member {Number} receiptUnitsPerCase
   */
  exports.prototype['receiptUnitsPerCase'] = undefined;
  /**
   * @member {Number} receiptUnitsPerPallet
   */
  exports.prototype['receiptUnitsPerPallet'] = undefined;
  /**
   * @member {Number} receiptVendor
   */
  exports.prototype['receiptVendor'] = undefined;
  /**
  ...
  /**
   * @member {Number} receiptReceiveQuantity
   */
  exports.prototype['receiptReceiveQuantity'] = undefined;
  /**
   * @member {Number} receiptNumberOfInnerPack
   */
  exports.prototype['receiptNumberOfInnerPack'] = undefined;
  /**
   * @member {Number} receiptNumberOfCases
   */
  exports.prototype['receiptNumberOfCases'] = undefined;
  /**
   * @member {Number} receiptNumberOfPallets
   */
  exports.prototype['receiptNumberOfPallets'] = undefined;
  /**
   * @member {Number} receivedNumberOfInnerPack
   */
  exports.prototype['receivedNumberOfInnerPack'] = undefined;
  /**
   * @member {Number} receivedNumberOfCases
   */
  exports.prototype['receivedNumberOfCases'] = undefined;
  /**
   * @member {Number} receivedNumberOfPallets
   */
  exports.prototype['receivedNumberOfPallets'] = undefined;
  /**
