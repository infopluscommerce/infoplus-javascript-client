...
(function(root, factory) {
   ...
   * @param parcelAccountId {Number} 
   * @param trackingNo {String} 
   * @param lobId {Number} 
   */
  var exports = function(orderId, carrierId, parcelAccountId, trackingNo, lobId) {
    var _this = this;
    ...
    _this['parcelAccountId'] = parcelAccountId;


    _this['trackingNo'] = trackingNo;
