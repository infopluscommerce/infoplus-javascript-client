...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('currentFulfillmentProcessId')) {
        obj['currentFulfillmentProcessId'] = ApiClient.convertToType(data['currentFulfillmentProcessId'], 'Number');
      }
      if (data.hasOwnProperty('currentWorkBatchId')) {
        obj['currentWorkBatchId'] = ApiClient.convertToType(data['currentWorkBatchId'], 'Number');
      }
  ...
  /**
   * @member {Number} currentFulfillmentProcessId
   */
  exports.prototype['currentFulfillmentProcessId'] = undefined;
  /**
   * @member {Number} currentWorkBatchId
   */
  exports.prototype['currentWorkBatchId'] = undefined;
  /**
