...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('itemSerials')) {
        obj['itemSerials'] = ApiClient.convertToType(data['itemSerials'], ['String']);
      }
  ...
  /**
   * @member {Array.<String>} itemSerials
   */
  exports.prototype['itemSerials'] = undefined;
  /**
