...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('backupDocument')) {
        obj['backupDocument'] = ApiClient.convertToType(data['backupDocument'], 'String');
      }
  ...
  /**
   * @member {String} backupDocument
   */
  exports.prototype['backupDocument'] = undefined;
  /**
