(function(root, factory) {
   ...
   * @param lobId
   * @param originalSKUId
   * @param supplementSKUId
   * @param type
   * @param supplementQuantity
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('originalSKUId')) {
        obj['originalSKUId'] = ApiClient.convertToType(data['originalSKUId'], 'Integer');
      }
      if (data.hasOwnProperty('supplementSKUId')) {
        obj['supplementSKUId'] = ApiClient.convertToType(data['supplementSKUId'], 'Integer');
      }
  ...
  /**
   * @member {Integer} originalSKUId
   */
  exports.prototype['originalSKUId'] = undefined;

  /**
   * @member {Integer} supplementSKUId
   */
