...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contentMixingRule')) {
        obj['contentMixingRule'] = ApiClient.convertToType(data['contentMixingRule'], 'String');
      }
  ...
  /**
   * @member {String} contentMixingRule
   */
  exports.prototype['contentMixingRule'] = undefined;
  /**
