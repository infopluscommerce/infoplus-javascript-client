...
(function(root, factory) {
   ...
   * @param packageCarrierId {Number} 
   * @param truckCarrierId {Number} 
   * @param weightBreak {Number} 
   * @param residential {String} 
   */
  var exports = function(lobId, customerNo, name, street, city, zipCode, country, packageCarrierId, truckCarrierId, weightBreak, residential) {
    ...
    _this['packageCarrierId'] = packageCarrierId;
    _this['truckCarrierId'] = truckCarrierId;
    _this['weightBreak'] = weightBreak;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('packageCarrierId')) {
        obj['packageCarrierId'] = ApiClient.convertToType(data['packageCarrierId'], 'Number');
      }
      if (data.hasOwnProperty('truckCarrierId')) {
        obj['truckCarrierId'] = ApiClient.convertToType(data['truckCarrierId'], 'Number');
      }
      if (data.hasOwnProperty('weightBreak')) {
        obj['weightBreak'] = ApiClient.convertToType(data['weightBreak'], 'Number');
      }
      ...
      if (data.hasOwnProperty('restrictionPercent')) {
        obj['restrictionPercent'] = ApiClient.convertToType(data['restrictionPercent'], 'Number');
      }
      ...
      if (data.hasOwnProperty('alternateInventory')) {
        obj['alternateInventory'] = ApiClient.convertToType(data['alternateInventory'], 'Number');
      }
  ...
  /**
   * @member {Number} restrictionPercent
   */
  ...
  /**
   * @member {Number} alternateInventory
   */
