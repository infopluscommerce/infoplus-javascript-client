...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allowUniqueSerialReturns')) {
        obj['allowUniqueSerialReturns'] = ApiClient.convertToType(data['allowUniqueSerialReturns'], 'String');
      }
  ...
  /**
   * @member {String} allowUniqueSerialReturns
   */
  exports.prototype['allowUniqueSerialReturns'] = undefined;
  /**
