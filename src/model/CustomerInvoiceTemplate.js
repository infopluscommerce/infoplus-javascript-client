...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./CustomerInvoiceTemplateLine'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.CustomerInvoiceTemplate = factory(root.infoplus.ApiClient, root.infoplus.CustomerInvoiceTemplateLine);
  }
  ...
  var exports = function(name, lobId, billingPeriod) {
    ...
    _this['lobId'] = lobId;
    _this['billingPeriod'] = billingPeriod;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lineItems')) {
        obj['lineItems'] = ApiClient.convertToType(data['lineItems'], [CustomerInvoiceTemplateLine]);
      }
  ...
  /**
   * @member {Array.<module:model/CustomerInvoiceTemplateLine>} lineItems
   */
