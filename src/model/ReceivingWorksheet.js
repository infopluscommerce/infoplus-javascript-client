...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReceivingWorksheetLineItem'], factory);
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('receivingProcessId')) {
        obj['receivingProcessId'] = ApiClient.convertToType(data['receivingProcessId'], 'Number');
      }
  ...
  /**
   * @member {Number} receivingProcessId
   */
