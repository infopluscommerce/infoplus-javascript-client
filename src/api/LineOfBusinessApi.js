...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/LineOfBusiness'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/LineOfBusiness'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.LineOfBusinessApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.LineOfBusiness);
  }
}(this, function(ApiClient, ApiResponse, LineOfBusiness) {
  'use strict';
