...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerInvoiceTemplateLine', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CustomerInvoiceTemplateLine'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.CustomerInvoiceTemplateLineApi = factory(root.infoplus.ApiClient, root.infoplus.CustomerInvoiceTemplateLine, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, CustomerInvoiceTemplateLine, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addCustomerInvoiceTemplateLineAudit = function(customerInvoiceTemplateLineId, customerInvoiceTemplateLineAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/audit/{customerInvoiceTemplateLineAudit}', 'PUT',
    ...
    this.addCustomerInvoiceTemplateLineFile = function(customerInvoiceTemplateLineId, fileName, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addCustomerInvoiceTemplateLineFileByURL operation.
     * @callback module:api/CustomerInvoiceTemplateLineApi~addCustomerInvoiceTemplateLineFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} customerInvoiceTemplateLineId Id of the customerInvoiceTemplateLine to add an file to
     * @param {module:api/CustomerInvoiceTemplateLineApi~addCustomerInvoiceTemplateLineFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addCustomerInvoiceTemplateLineFileByURL = function(body, customerInvoiceTemplateLineId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addCustomerInvoiceTemplateLineFileByURL");
      }

      // verify the required parameter 'customerInvoiceTemplateLineId' is set
      if (customerInvoiceTemplateLineId === undefined || customerInvoiceTemplateLineId === null) {
        throw new Error("Missing the required parameter 'customerInvoiceTemplateLineId' when calling addCustomerInvoiceTemplateLineFileByURL");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addCustomerInvoiceTemplateLineTag = function(customerInvoiceTemplateLineId, customerInvoiceTemplateLineTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteCustomerInvoiceTemplateLine = function(customerInvoiceTemplateLineId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteCustomerInvoiceTemplateLineFile operation.
     * @callback module:api/CustomerInvoiceTemplateLineApi~deleteCustomerInvoiceTemplateLineFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} customerInvoiceTemplateLineId Id of the customerInvoiceTemplateLine to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/CustomerInvoiceTemplateLineApi~deleteCustomerInvoiceTemplateLineFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteCustomerInvoiceTemplateLineFile = function(customerInvoiceTemplateLineId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'customerInvoiceTemplateLineId' is set
      if (customerInvoiceTemplateLineId === undefined || customerInvoiceTemplateLineId === null) {
        throw new Error("Missing the required parameter 'customerInvoiceTemplateLineId' when calling deleteCustomerInvoiceTemplateLineFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteCustomerInvoiceTemplateLineFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteCustomerInvoiceTemplateLineTag = function(customerInvoiceTemplateLineId, customerInvoiceTemplateLineTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag/{customerInvoiceTemplateLineTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getCustomerInvoiceTemplateLineByFilter = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getCustomerInvoiceTemplateLineById = function(customerInvoiceTemplateLineId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getCustomerInvoiceTemplateLineFiles operation.
     * @callback module:api/CustomerInvoiceTemplateLineApi~getCustomerInvoiceTemplateLineFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} customerInvoiceTemplateLineId Id of the customerInvoiceTemplateLine to get files for
     * @param {module:api/CustomerInvoiceTemplateLineApi~getCustomerInvoiceTemplateLineFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getCustomerInvoiceTemplateLineFiles = function(customerInvoiceTemplateLineId, callback) {
      var postBody = null;

      // verify the required parameter 'customerInvoiceTemplateLineId' is set
      if (customerInvoiceTemplateLineId === undefined || customerInvoiceTemplateLineId === null) {
        throw new Error("Missing the required parameter 'customerInvoiceTemplateLineId' when calling getCustomerInvoiceTemplateLineFiles");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getCustomerInvoiceTemplateLineTags = function(customerInvoiceTemplateLineId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/{customerInvoiceTemplateLineId}/tag', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateCustomerInvoiceTemplateLineById = function(customerInvoiceTemplateLineId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine/duplicate/{customerInvoiceTemplateLineId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateCustomerInvoiceTemplateLine = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/customerInvoiceTemplateLine', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
