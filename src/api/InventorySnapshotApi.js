...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    this.addInventorySnapshotFileByURL = function(body, inventorySnapshotId, callback) {
      ...
      return this.apiClient.callApi(
        '/beta/inventorySnapshot/{inventorySnapshotId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteInventorySnapshotFile = function(inventorySnapshotId, fileId, callback) {
      ...
      return this.apiClient.callApi(
        '/beta/inventorySnapshot/{inventorySnapshotId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getInventorySnapshotFiles = function(inventorySnapshotId, callback) {
      ...
      return this.apiClient.callApi(
        '/beta/inventorySnapshot/{inventorySnapshotId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
