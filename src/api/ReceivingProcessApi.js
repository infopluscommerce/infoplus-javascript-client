...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReceivingProcess', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ReceivingProcess'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.ReceivingProcessApi = factory(root.infoplus.ApiClient, root.infoplus.ReceivingProcess, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ReceivingProcess, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addReceivingProcessAudit = function(receivingProcessId, receivingProcessAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/audit/{receivingProcessAudit}', 'PUT',
    ...
    /**
     * Callback function to receive the result of the addReceivingProcessFile operation.
     * @callback module:api/ReceivingProcessApi~addReceivingProcessFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} receivingProcessId Id of the receivingProcess to add a file to
     * @param {String} fileName Name of file
     * @param {module:api/ReceivingProcessApi~addReceivingProcessFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addReceivingProcessFile = function(receivingProcessId, fileName, callback) {
      var postBody = null;

      // verify the required parameter 'receivingProcessId' is set
      if (receivingProcessId === undefined || receivingProcessId === null) {
        throw new Error("Missing the required parameter 'receivingProcessId' when calling addReceivingProcessFile");
      }

      // verify the required parameter 'fileName' is set
      if (fileName === undefined || fileName === null) {
        throw new Error("Missing the required parameter 'fileName' when calling addReceivingProcessFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addReceivingProcessFileByURL operation.
     * @callback module:api/ReceivingProcessApi~addReceivingProcessFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} receivingProcessId Id of the receivingProcess to add an file to
     * @param {module:api/ReceivingProcessApi~addReceivingProcessFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addReceivingProcessFileByURL = function(body, receivingProcessId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addReceivingProcessFileByURL");
      }

      // verify the required parameter 'receivingProcessId' is set
      if (receivingProcessId === undefined || receivingProcessId === null) {
        throw new Error("Missing the required parameter 'receivingProcessId' when calling addReceivingProcessFileByURL");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addReceivingProcessTag = function(receivingProcessId, receivingProcessTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/tag/{receivingProcessTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteReceivingProcessFile operation.
     * @callback module:api/ReceivingProcessApi~deleteReceivingProcessFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} receivingProcessId Id of the receivingProcess to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/ReceivingProcessApi~deleteReceivingProcessFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteReceivingProcessFile = function(receivingProcessId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'receivingProcessId' is set
      if (receivingProcessId === undefined || receivingProcessId === null) {
        throw new Error("Missing the required parameter 'receivingProcessId' when calling deleteReceivingProcessFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteReceivingProcessFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteReceivingProcessTag = function(receivingProcessId, receivingProcessTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/tag/{receivingProcessTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateReceivingProcessById = function(receivingProcessId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/duplicate/{receivingProcessId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getReceivingProcessByFilter = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getReceivingProcessById = function(receivingProcessId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getReceivingProcessFiles operation.
     * @callback module:api/ReceivingProcessApi~getReceivingProcessFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} receivingProcessId Id of the receivingProcess to get files for
     * @param {module:api/ReceivingProcessApi~getReceivingProcessFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getReceivingProcessFiles = function(receivingProcessId, callback) {
      var postBody = null;

      // verify the required parameter 'receivingProcessId' is set
      if (receivingProcessId === undefined || receivingProcessId === null) {
        throw new Error("Missing the required parameter 'receivingProcessId' when calling getReceivingProcessFiles");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getReceivingProcessTags = function(receivingProcessId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/{receivingProcessId}/tag', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateReceivingProcessCustomFields = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/receivingProcess/customFields', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
