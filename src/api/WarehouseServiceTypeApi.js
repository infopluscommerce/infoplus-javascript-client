...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/WarehouseServiceType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/WarehouseServiceType'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.WarehouseServiceTypeApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.WarehouseServiceType);
  }
}(this, function(ApiClient, ApiResponse, WarehouseServiceType) {
  'use strict';
