...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/JobTime', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/JobTime'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.JobTimeApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.JobTime, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ApiResponse, JobTime, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addJobTimeAudit = function(jobTimeId, jobTimeAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/audit/{jobTimeAudit}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addJobTimeFile = function(jobTimeId, fileName, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addJobTimeFileByURL operation.
     * @callback module:api/JobTimeApi~addJobTimeFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} jobTimeId Id of the jobTime to add an file to
     * @param {module:api/JobTimeApi~addJobTimeFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addJobTimeFileByURL = function(body, jobTimeId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addJobTimeFileByURL");
      }

      // verify the required parameter 'jobTimeId' is set
      if (jobTimeId === undefined || jobTimeId === null) {
        throw new Error("Missing the required parameter 'jobTimeId' when calling addJobTimeFileByURL");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addJobTimeTag = function(jobTimeId, jobTimeTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteJobTimeFile operation.
     * @callback module:api/JobTimeApi~deleteJobTimeFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} jobTimeId Id of the jobTime to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/JobTimeApi~deleteJobTimeFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteJobTimeFile = function(jobTimeId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'jobTimeId' is set
      if (jobTimeId === undefined || jobTimeId === null) {
        throw new Error("Missing the required parameter 'jobTimeId' when calling deleteJobTimeFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteJobTimeFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteJobTimeTag = function(jobTimeId, jobTimeTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateJobTimeById = function(jobTimeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/duplicate/{jobTimeId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getJobTimeFiles operation.
     * @callback module:api/JobTimeApi~getJobTimeFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} jobTimeId Id of the jobTime to get files for
     * @param {module:api/JobTimeApi~getJobTimeFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getJobTimeFiles = function(jobTimeId, callback) {
      var postBody = null;

      // verify the required parameter 'jobTimeId' is set
      if (jobTimeId === undefined || jobTimeId === null) {
        throw new Error("Missing the required parameter 'jobTimeId' when calling getJobTimeFiles");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getJobTimeTags = function(jobTimeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/jobTime/{jobTimeId}/tag', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
