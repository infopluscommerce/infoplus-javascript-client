(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getDuplicateParcelShipmentById operation.
     * @callback module:api/ParcelShipmentApi~getDuplicateParcelShipmentByIdCallback
     ...
     * @param {Integer} parcelShipmentId Id of the parcelShipment to be duplicated.
     * @param {module:api/ParcelShipmentApi~getDuplicateParcelShipmentByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/ParcelShipment}
     */
    this.getDuplicateParcelShipmentById = function(parcelShipmentId, callback) {
      var postBody = null;

      // verify the required parameter 'parcelShipmentId' is set
      if (parcelShipmentId == undefined || parcelShipmentId == null) {
        throw "Missing the required parameter 'parcelShipmentId' when calling getDuplicateParcelShipmentById";
      }
      ...
      return this.apiClient.callApi(
        '/v2.0/parcelShipment/duplicate/{parcelShipmentId}', 'GET',
    ...
    this.getParcelShipmentByFilter = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2.0/parcelShipment/search', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getParcelShipmentById = function(parcelShipmentId, callback) {
      ...
      return this.apiClient.callApi(
        '/v2.0/parcelShipment/{parcelShipmentId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateParcelShipmentCustomFields = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v2.0/parcelShipment/customFields', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
