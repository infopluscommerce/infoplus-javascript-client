(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to add an audit to
    ...
    this.addParcelInvoiceLineAudit = function(parcelInvoiceLineId, parcelInvoiceLineAudit, callback) {
      ...
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling addParcelInvoiceLineAudit";
      }
      ...
      if (parcelInvoiceLineAudit == undefined || parcelInvoiceLineAudit == null) {
        throw "Missing the required parameter 'parcelInvoiceLineAudit' when calling addParcelInvoiceLineAudit";
      }
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to add a tag to
    ...
    this.addParcelInvoiceLineTag = function(parcelInvoiceLineId, parcelInvoiceLineTag, callback) {
      ...
      // verify the required parameter 'parcelInvoiceLineId' is set
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling addParcelInvoiceLineTag";
      }

      // verify the required parameter 'parcelInvoiceLineTag' is set
      if (parcelInvoiceLineTag == undefined || parcelInvoiceLineTag == null) {
        throw "Missing the required parameter 'parcelInvoiceLineTag' when calling addParcelInvoiceLineTag";
      }
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to remove tag from
    ...
    this.deleteParcelInvoiceLineTag = function(parcelInvoiceLineId, parcelInvoiceLineTag, callback) {
      ...
      // verify the required parameter 'parcelInvoiceLineId' is set
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling deleteParcelInvoiceLineTag";
      }

      // verify the required parameter 'parcelInvoiceLineTag' is set
      if (parcelInvoiceLineTag == undefined || parcelInvoiceLineTag == null) {
        throw "Missing the required parameter 'parcelInvoiceLineTag' when calling deleteParcelInvoiceLineTag";
      }
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to be duplicated.
     ...
     * data is of type: {module:model/ParcelInvoiceLine}
     */
    this.getDuplicateParcelInvoiceLineById = function(parcelInvoiceLineId, callback) {
      ...
      // verify the required parameter 'parcelInvoiceLineId' is set
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling getDuplicateParcelInvoiceLineById";
      }
     ...
     * data is of type: {Array.<module:model/ParcelInvoiceLine>}
     */
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to be returned.
    ...
    this.getParcelInvoiceLineById = function(parcelInvoiceLineId, callback) {
      ...
      // verify the required parameter 'parcelInvoiceLineId' is set
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling getParcelInvoiceLineById";
      }
     ...
     * @param {Integer} parcelInvoiceLineId Id of the parcelInvoiceLine to get tags for
    ...
    this.getParcelInvoiceLineTags = function(parcelInvoiceLineId, callback) {
      ...
      // verify the required parameter 'parcelInvoiceLineId' is set
      if (parcelInvoiceLineId == undefined || parcelInvoiceLineId == null) {
        throw "Missing the required parameter 'parcelInvoiceLineId' when calling getParcelInvoiceLineTags";
      }
    ...
    this.updateParcelInvoiceLine = function(body, callback) {
      ...
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling updateParcelInvoiceLine";
      }
