(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/BillingCodeActivity', '../model/ApiResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BillingCodeActivity'), require('../model/ApiResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.BillingCodeActivityApi = factory(root.infoplus.ApiClient, root.infoplus.BillingCodeActivity, root.infoplus.ApiResponse);
  }
}(this, function(ApiClient, BillingCodeActivity, ApiResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * data is of type: {module:model/BillingCodeActivity}
     */
    this.addBillingCodeActivity = function(body, callback) {
      ...
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling addBillingCodeActivity";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to add an audit to
    ...
    this.addBillingCodeActivityAudit = function(billingCodeActivityId, billingCodeActivityAudit, callback) {
      ...
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling addBillingCodeActivityAudit";
      }
      ...
      if (billingCodeActivityAudit == undefined || billingCodeActivityAudit == null) {
        throw "Missing the required parameter 'billingCodeActivityAudit' when calling addBillingCodeActivityAudit";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to add a tag to
    ...
    this.addBillingCodeActivityTag = function(billingCodeActivityId, billingCodeActivityTag, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling addBillingCodeActivityTag";
      }
      ...
      if (billingCodeActivityTag == undefined || billingCodeActivityTag == null) {
        throw "Missing the required parameter 'billingCodeActivityTag' when calling addBillingCodeActivityTag";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to be deleted.
    ...
    this.deleteBillingCodeActivity = function(billingCodeActivityId, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling deleteBillingCodeActivity";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to remove tag from
    ...
    this.deleteBillingCodeActivityTag = function(billingCodeActivityId, billingCodeActivityTag, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling deleteBillingCodeActivityTag";
      }

      // verify the required parameter 'billingCodeActivityTag' is set
      if (billingCodeActivityTag == undefined || billingCodeActivityTag == null) {
        throw "Missing the required parameter 'billingCodeActivityTag' when calling deleteBillingCodeActivityTag";
      }
     ...
     * data is of type: {Array.<module:model/BillingCodeActivity>}
     */
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to be returned.
    ...
    this.getBillingCodeActivityById = function(billingCodeActivityId, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling getBillingCodeActivityById";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to get tags for
    ...
    this.getBillingCodeActivityTags = function(billingCodeActivityId, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling getBillingCodeActivityTags";
      }
     ...
     * @param {Integer} billingCodeActivityId Id of the billingCodeActivity to be duplicated.
    ...
    this.getDuplicateBillingCodeActivityById = function(billingCodeActivityId, callback) {
      ...
      // verify the required parameter 'billingCodeActivityId' is set
      if (billingCodeActivityId == undefined || billingCodeActivityId == null) {
        throw "Missing the required parameter 'billingCodeActivityId' when calling getDuplicateBillingCodeActivityById";
      }
    ...
    this.updateBillingCodeActivity = function(body, callback) {
      ...
      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling updateBillingCodeActivity";
      }
