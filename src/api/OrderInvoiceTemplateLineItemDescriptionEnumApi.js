...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * data is of type: {@link module:model/OrderInvoiceTemplateLineItemDescriptionEnum}
     */
    this.getOrderInvoiceTemplateLineItemDescriptionEnumById = function(orderInvoiceTemplateLineItemDescriptionEnumId, callback) {
      ...
      if (orderInvoiceTemplateLineItemDescriptionEnumId === undefined || orderInvoiceTemplateLineItemDescriptionEnumId === null) {
        throw new Error("Missing the required parameter 'orderInvoiceTemplateLineItemDescriptionEnumId' when calling getOrderInvoiceTemplateLineItemDescriptionEnumById");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/orderInvoiceTemplateLineItemDescriptionEnum/{orderInvoiceTemplateLineItemDescriptionEnumId}', 'GET',
     ...
     * data is of type: {@link Array.<module:model/OrderInvoiceTemplateLineItemDescriptionEnum>}
     */
    this.getOrderInvoiceTemplateLineItemDescriptionEnumBySearchText = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/orderInvoiceTemplateLineItemDescriptionEnum/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
