...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the addSlaSetupFile operation.
     * @callback module:api/SlaSetupApi~addSlaSetupFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} slaSetupId Id of the slaSetup to add a file to
     * @param {String} fileName Name of file
     * @param {module:api/SlaSetupApi~addSlaSetupFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addSlaSetupFile = function(slaSetupId, fileName, callback) {
      var postBody = null;

      // verify the required parameter 'slaSetupId' is set
      if (slaSetupId === undefined || slaSetupId === null) {
        throw new Error("Missing the required parameter 'slaSetupId' when calling addSlaSetupFile");
      }

      // verify the required parameter 'fileName' is set
      if (fileName === undefined || fileName === null) {
        throw new Error("Missing the required parameter 'fileName' when calling addSlaSetupFile");
      }
