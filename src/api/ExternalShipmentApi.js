...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ExecuteExternalShipmentInputAPIModel', 'model/ExternalShipment', 'model/ProcessOutputAPIModel', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/ExecuteExternalShipmentInputAPIModel'), require('../model/ExternalShipment'), require('../model/ProcessOutputAPIModel'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.ExternalShipmentApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.ExecuteExternalShipmentInputAPIModel, root.infoplus.ExternalShipment, root.infoplus.ProcessOutputAPIModel, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ApiResponse, ExecuteExternalShipmentInputAPIModel, ExternalShipment, ProcessOutputAPIModel, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the executeExternalShipment operation.
     * @callback module:api/ExternalShipmentApi~executeExternalShipmentCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {module:model/ExecuteExternalShipmentInputAPIModel} body Input data for ExecuteExternalShipment process.
     * @param {module:api/ExternalShipmentApi~executeExternalShipmentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProcessOutputAPIModel>}
     */
    this.executeExternalShipment = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling executeExternalShipment");
      }
      ...
      return this.apiClient.callApi(
        '/beta/externalShipment/executeExternalShipment', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
