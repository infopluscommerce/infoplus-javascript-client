...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/Asn', 'model/ClosePurchProcessInputAPIModel', 'model/ProcessOutputAPIModel', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/Asn'), require('../model/ClosePurchProcessInputAPIModel'), require('../model/ProcessOutputAPIModel'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.AsnApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.Asn, root.infoplus.ClosePurchProcessInputAPIModel, root.infoplus.ProcessOutputAPIModel, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ApiResponse, Asn, ClosePurchProcessInputAPIModel, ProcessOutputAPIModel, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the closeAsn operation.
     * @callback module:api/AsnApi~closeAsnCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {module:model/ClosePurchProcessInputAPIModel} body Input data for ClosePurchProcess process.
     * @param {module:api/AsnApi~closeAsnCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ProcessOutputAPIModel>}
     */
    this.closeAsn = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling closeAsn");
      }
