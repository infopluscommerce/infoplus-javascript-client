...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/LocationBillingType', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/LocationBillingType'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.LocationBillingTypeApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.LocationBillingType, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ApiResponse, LocationBillingType, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addLocationBillingTypeAudit = function(locationBillingTypeId, locationBillingTypeAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/audit/{locationBillingTypeAudit}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addLocationBillingTypeFile = function(locationBillingTypeId, fileName, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addLocationBillingTypeFileByURL operation.
     * @callback module:api/LocationBillingTypeApi~addLocationBillingTypeFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationBillingTypeId Id of the locationBillingType to add an file to
     * @param {module:api/LocationBillingTypeApi~addLocationBillingTypeFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addLocationBillingTypeFileByURL = function(body, locationBillingTypeId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addLocationBillingTypeFileByURL");
      }

      // verify the required parameter 'locationBillingTypeId' is set
      if (locationBillingTypeId === undefined || locationBillingTypeId === null) {
        throw new Error("Missing the required parameter 'locationBillingTypeId' when calling addLocationBillingTypeFileByURL");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addLocationBillingTypeTag = function(locationBillingTypeId, locationBillingTypeTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/tag/{locationBillingTypeTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteLocationBillingType = function(locationBillingTypeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteLocationBillingTypeFile operation.
     * @callback module:api/LocationBillingTypeApi~deleteLocationBillingTypeFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationBillingTypeId Id of the locationBillingType to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/LocationBillingTypeApi~deleteLocationBillingTypeFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteLocationBillingTypeFile = function(locationBillingTypeId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'locationBillingTypeId' is set
      if (locationBillingTypeId === undefined || locationBillingTypeId === null) {
        throw new Error("Missing the required parameter 'locationBillingTypeId' when calling deleteLocationBillingTypeFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteLocationBillingTypeFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteLocationBillingTypeTag = function(locationBillingTypeId, locationBillingTypeTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/tag/{locationBillingTypeTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateLocationBillingTypeById = function(locationBillingTypeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/duplicate/{locationBillingTypeId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationBillingTypeByFilter = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationBillingTypeById = function(locationBillingTypeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLocationBillingTypeFiles operation.
     * @callback module:api/LocationBillingTypeApi~getLocationBillingTypeFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationBillingTypeId Id of the locationBillingType to get files for
     * @param {module:api/LocationBillingTypeApi~getLocationBillingTypeFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getLocationBillingTypeFiles = function(locationBillingTypeId, callback) {
      var postBody = null;

      // verify the required parameter 'locationBillingTypeId' is set
      if (locationBillingTypeId === undefined || locationBillingTypeId === null) {
        throw new Error("Missing the required parameter 'locationBillingTypeId' when calling getLocationBillingTypeFiles");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationBillingTypeTags = function(locationBillingTypeId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/{locationBillingTypeId}/tag', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateLocationBillingTypeCustomFields = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationBillingType/customFields', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
