...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ReceivingWorksheet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/ReceivingWorksheet'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.ReceivingWorksheetApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.ReceivingWorksheet);
  }
}(this, function(ApiClient, ApiResponse, ReceivingWorksheet) {
  'use strict';
