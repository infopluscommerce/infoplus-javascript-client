...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ApplyOrderWarehouseFulfillmentPlanInput', 'model/ApplyOrderWarehouseFulfillmentPlanOutput', 'model/EditLineItemFulfillmentStrategyInputAPIModel', 'model/GetOrderPackDataInput', 'model/GetOrderPackDataOutput', 'model/GetOrderWarehouseFulfillmentDataInput', 'model/GetOrderWarehouseFulfillmentDataOutput', 'model/Order', 'model/ProcessOutputAPIModel', 'model/RecordFile', 'model/ReqManualSubstitutionInputAPIModel', 'model/RunFulfillmentPlanInputAPIModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/ApplyOrderWarehouseFulfillmentPlanInput'), require('../model/ApplyOrderWarehouseFulfillmentPlanOutput'), require('../model/EditLineItemFulfillmentStrategyInputAPIModel'), require('../model/GetOrderPackDataInput'), require('../model/GetOrderPackDataOutput'), require('../model/GetOrderWarehouseFulfillmentDataInput'), require('../model/GetOrderWarehouseFulfillmentDataOutput'), require('../model/Order'), require('../model/ProcessOutputAPIModel'), require('../model/RecordFile'), require('../model/ReqManualSubstitutionInputAPIModel'), require('../model/RunFulfillmentPlanInputAPIModel'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.OrderApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.ApplyOrderWarehouseFulfillmentPlanInput, root.infoplus.ApplyOrderWarehouseFulfillmentPlanOutput, root.infoplus.EditLineItemFulfillmentStrategyInputAPIModel, root.infoplus.GetOrderPackDataInput, root.infoplus.GetOrderPackDataOutput, root.infoplus.GetOrderWarehouseFulfillmentDataInput, root.infoplus.GetOrderWarehouseFulfillmentDataOutput, root.infoplus.Order, root.infoplus.ProcessOutputAPIModel, root.infoplus.RecordFile, root.infoplus.ReqManualSubstitutionInputAPIModel, root.infoplus.RunFulfillmentPlanInputAPIModel);
  }
}(this, function(ApiClient, ApiResponse, ApplyOrderWarehouseFulfillmentPlanInput, ApplyOrderWarehouseFulfillmentPlanOutput, EditLineItemFulfillmentStrategyInputAPIModel, GetOrderPackDataInput, GetOrderPackDataOutput, GetOrderWarehouseFulfillmentDataInput, GetOrderWarehouseFulfillmentDataOutput, Order, ProcessOutputAPIModel, RecordFile, ReqManualSubstitutionInputAPIModel, RunFulfillmentPlanInputAPIModel) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addOrderAudit = function(orderId, orderAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/{orderId}/audit/{orderAudit}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addOrderFile = function(orderId, fileName, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/{orderId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addOrderFileByURL operation.
     * @callback module:api/OrderApi~addOrderFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} orderId Id of the order to add an file to
     * @param {module:api/OrderApi~addOrderFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addOrderFileByURL = function(body, orderId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addOrderFileByURL");
      }

      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling addOrderFileByURL");
      }
    ...
    this.addOrderTag = function(orderId, orderTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/{orderId}/tag/{orderTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.applyOrderWarehouseFulfillmentPlan = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/applyOrderWarehouseFulfillmentPlan', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteOrderFile operation.
     * @callback module:api/OrderApi~deleteOrderFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} orderId Id of the order to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/OrderApi~deleteOrderFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteOrderFile = function(orderId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling deleteOrderFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteOrderFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/order/{orderId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteOrderTag = function(orderId, orderTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/{orderId}/tag/{orderTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.editFulfillmentChannel = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/editFulfillmentChannel', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateOrderById = function(orderId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/duplicate/{orderId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getOrderFiles operation.
     * @callback module:api/OrderApi~getOrderFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} orderId Id of the order to get files for
     * @param {module:api/OrderApi~getOrderFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getOrderFiles = function(orderId, callback) {
      var postBody = null;

      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling getOrderFiles");
      }
    ...
    /**
     * Callback function to receive the result of the getOrderPackData operation.
     * @callback module:api/OrderApi~getOrderPackDataCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetOrderPackDataOutput} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {module:model/GetOrderPackDataInput} body Input data for Get Order Pack Data process.
     * @param {module:api/OrderApi~getOrderPackDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetOrderPackDataOutput}
     */
    this.getOrderPackData = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling getOrderPackData");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = GetOrderPackDataOutput;

      return this.apiClient.callApi(
        '/v3.0/order/getOrderPackData', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getOrderWarehouseFulfillmentData = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/getOrderWarehouseFulfillmentData', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.runFulfillmentPlan = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/order/runFulfillmentPlan', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
