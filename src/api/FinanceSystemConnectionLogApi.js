...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/FinanceSystemConnectionLog'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/FinanceSystemConnectionLog'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.FinanceSystemConnectionLogApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.FinanceSystemConnectionLog);
  }
}(this, function(ApiClient, ApiResponse, FinanceSystemConnectionLog) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the addFinanceSystemConnectionLog operation.
     * @callback module:api/FinanceSystemConnectionLogApi~addFinanceSystemConnectionLogCallback
     ...
     * @param {module:model/FinanceSystemConnectionLog} body FinanceSystemConnectionLog to be inserted.
     * @param {module:api/FinanceSystemConnectionLogApi~addFinanceSystemConnectionLogCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FinanceSystemConnectionLog}
     */
    this.addFinanceSystemConnectionLog = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addFinanceSystemConnectionLog");
      }
      ...
      return this.apiClient.callApi(
        '/beta/financeSystemConnectionLog', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteFinanceSystemConnectionLog operation.
     * @callback module:api/FinanceSystemConnectionLogApi~deleteFinanceSystemConnectionLogCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} financeSystemConnectionLogId Id of the financeSystemConnectionLog to be deleted.
     * @param {module:api/FinanceSystemConnectionLogApi~deleteFinanceSystemConnectionLogCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteFinanceSystemConnectionLog = function(financeSystemConnectionLogId, callback) {
      var postBody = null;

      // verify the required parameter 'financeSystemConnectionLogId' is set
      if (financeSystemConnectionLogId === undefined || financeSystemConnectionLogId === null) {
        throw new Error("Missing the required parameter 'financeSystemConnectionLogId' when calling deleteFinanceSystemConnectionLog");
      }
      ...
      return this.apiClient.callApi(
        '/beta/financeSystemConnectionLog/{financeSystemConnectionLogId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateFinanceSystemConnectionLog operation.
     * @callback module:api/FinanceSystemConnectionLogApi~updateFinanceSystemConnectionLogCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/FinanceSystemConnectionLog} body FinanceSystemConnectionLog to be updated.
     * @param {module:api/FinanceSystemConnectionLogApi~updateFinanceSystemConnectionLogCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateFinanceSystemConnectionLog = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateFinanceSystemConnectionLog");
      }
      ...
      return this.apiClient.callApi(
        '/beta/financeSystemConnectionLog', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
