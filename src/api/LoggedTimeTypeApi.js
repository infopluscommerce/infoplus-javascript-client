...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * data is of type: {@link module:model/LoggedTimeType}
     */
    this.getLoggedTimeTypeById = function(loggedTimeTypeId, callback) {
      ...
      if (loggedTimeTypeId === undefined || loggedTimeTypeId === null) {
        throw new Error("Missing the required parameter 'loggedTimeTypeId' when calling getLoggedTimeTypeById");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/loggedTimeType/{loggedTimeTypeId}', 'GET',
     ...
     * data is of type: {@link Array.<module:model/LoggedTimeType>}
     */
    this.getLoggedTimeTypeBySearchText = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/loggedTimeType/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
