...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/LocationFootprint', 'model/RecordFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/LocationFootprint'), require('../model/RecordFile'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.LocationFootprintApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.LocationFootprint, root.infoplus.RecordFile);
  }
}(this, function(ApiClient, ApiResponse, LocationFootprint, RecordFile) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.addLocationFootprintAudit = function(locationFootprintId, locationFootprintAudit, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/audit/{locationFootprintAudit}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addLocationFootprintFile operation.
     * @callback module:api/LocationFootprintApi~addLocationFootprintFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationFootprintId Id of the locationFootprint to add a file to
     * @param {String} fileName Name of file
     * @param {module:api/LocationFootprintApi~addLocationFootprintFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addLocationFootprintFile = function(locationFootprintId, fileName, callback) {
      var postBody = null;

      // verify the required parameter 'locationFootprintId' is set
      if (locationFootprintId === undefined || locationFootprintId === null) {
        throw new Error("Missing the required parameter 'locationFootprintId' when calling addLocationFootprintFile");
      }

      // verify the required parameter 'fileName' is set
      if (fileName === undefined || fileName === null) {
        throw new Error("Missing the required parameter 'fileName' when calling addLocationFootprintFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/file/{fileName}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the addLocationFootprintFileByURL operation.
     * @callback module:api/LocationFootprintApi~addLocationFootprintFileByURLCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationFootprintId Id of the locationFootprint to add an file to
     * @param {module:api/LocationFootprintApi~addLocationFootprintFileByURLCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addLocationFootprintFileByURL = function(body, locationFootprintId, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addLocationFootprintFileByURL");
      }

      // verify the required parameter 'locationFootprintId' is set
      if (locationFootprintId === undefined || locationFootprintId === null) {
        throw new Error("Missing the required parameter 'locationFootprintId' when calling addLocationFootprintFileByURL");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.addLocationFootprintTag = function(locationFootprintId, locationFootprintTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/tag/{locationFootprintTag}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteLocationFootprint = function(locationFootprintId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteLocationFootprintFile operation.
     * @callback module:api/LocationFootprintApi~deleteLocationFootprintFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationFootprintId Id of the locationFootprint to remove file from
     * @param {Number} fileId Id of the file to delete
     * @param {module:api/LocationFootprintApi~deleteLocationFootprintFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteLocationFootprintFile = function(locationFootprintId, fileId, callback) {
      var postBody = null;

      // verify the required parameter 'locationFootprintId' is set
      if (locationFootprintId === undefined || locationFootprintId === null) {
        throw new Error("Missing the required parameter 'locationFootprintId' when calling deleteLocationFootprintFile");
      }

      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling deleteLocationFootprintFile");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/file/{fileId}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteLocationFootprintTag = function(locationFootprintId, locationFootprintTag, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/tag/{locationFootprintTag}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getDuplicateLocationFootprintById = function(locationFootprintId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/duplicate/{locationFootprintId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationFootprintByFilter = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/search', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationFootprintById = function(locationFootprintId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLocationFootprintFiles operation.
     * @callback module:api/LocationFootprintApi~getLocationFootprintFilesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} locationFootprintId Id of the locationFootprint to get files for
     * @param {module:api/LocationFootprintApi~getLocationFootprintFilesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getLocationFootprintFiles = function(locationFootprintId, callback) {
      var postBody = null;

      // verify the required parameter 'locationFootprintId' is set
      if (locationFootprintId === undefined || locationFootprintId === null) {
        throw new Error("Missing the required parameter 'locationFootprintId' when calling getLocationFootprintFiles");
      }
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/file', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getLocationFootprintTags = function(locationFootprintId, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/{locationFootprintId}/tag', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateLocationFootprintCustomFields = function(body, callback) {
      ...
      return this.apiClient.callApi(
        '/v3.0/locationFootprint/customFields', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
