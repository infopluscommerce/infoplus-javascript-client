...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/Substitution'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiResponse'), require('../model/Substitution'));
  } else {
    // Browser globals (root is window)
    if (!root.infoplus) {
      root.infoplus = {};
    }
    root.infoplus.SubstitutionApi = factory(root.infoplus.ApiClient, root.infoplus.ApiResponse, root.infoplus.Substitution);
  }
}(this, function(ApiClient, ApiResponse, Substitution) {
  'use strict';
