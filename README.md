...
*infoplus.AsnApi* | [**closeAsn**](docs/AsnApi.md#closeAsn) | **POST** /beta/asn/closeAsn | Run the ClosePurchProcess process.
...
*infoplus.CarrierCompanyCodeApi* | [**getCarrierCompanyCodeById**](docs/CarrierCompanyCodeApi.md#getCarrierCompanyCodeById) | **GET** /beta/carrierCompanyCode/{carrierCompanyCodeId} | Get a carrierCompanyCode by id
*infoplus.CarrierCompanyCodeApi* | [**getCarrierCompanyCodeBySearchText**](docs/CarrierCompanyCodeApi.md#getCarrierCompanyCodeBySearchText) | **GET** /beta/carrierCompanyCode/search | Search carrierCompanyCodes
...
*infoplus.DasFeeTypeApi* | [**getDASFeeTypeById**](docs/DasFeeTypeApi.md#getDASFeeTypeById) | **GET** /beta/dasFeeType/{dasFeeTypeId} | Get a dasFeeType by id
*infoplus.DasFeeTypeApi* | [**getDasFeeTypeBySearchText**](docs/DasFeeTypeApi.md#getDasFeeTypeBySearchText) | **GET** /beta/dasFeeType/search | Search dasFeeTypes
*infoplus.DasFeesApi* | [**addDasFees**](docs/DasFeesApi.md#addDasFees) | **POST** /beta/dasFees | Create a dasFees
*infoplus.DasFeesApi* | [**addDasFeesAudit**](docs/DasFeesApi.md#addDasFeesAudit) | **PUT** /beta/dasFees/{dasFeesId}/audit/{dasFeesAudit} | Add new audit for a dasFees
*infoplus.DasFeesApi* | [**addDasFeesFile**](docs/DasFeesApi.md#addDasFeesFile) | **POST** /beta/dasFees/{dasFeesId}/file/{fileName} | Attach a file to a dasFees
*infoplus.DasFeesApi* | [**addDasFeesFileByURL**](docs/DasFeesApi.md#addDasFeesFileByURL) | **POST** /beta/dasFees/{dasFeesId}/file | Attach a file to a dasFees by URL.
*infoplus.DasFeesApi* | [**addDasFeesTag**](docs/DasFeesApi.md#addDasFeesTag) | **PUT** /beta/dasFees/{dasFeesId}/tag/{dasFeesTag} | Add new tags for a dasFees.
*infoplus.DasFeesApi* | [**deleteDasFees**](docs/DasFeesApi.md#deleteDasFees) | **DELETE** /beta/dasFees/{dasFeesId} | Delete a dasFees
*infoplus.DasFeesApi* | [**deleteDasFeesFile**](docs/DasFeesApi.md#deleteDasFeesFile) | **DELETE** /beta/dasFees/{dasFeesId}/file/{fileId} | Delete a file for a dasFees.
*infoplus.DasFeesApi* | [**deleteDasFeesTag**](docs/DasFeesApi.md#deleteDasFeesTag) | **DELETE** /beta/dasFees/{dasFeesId}/tag/{dasFeesTag} | Delete a tag for a dasFees.
*infoplus.DasFeesApi* | [**getDasFeesByFilter**](docs/DasFeesApi.md#getDasFeesByFilter) | **GET** /beta/dasFees/search | Search dasFeeses by filter
*infoplus.DasFeesApi* | [**getDasFeesById**](docs/DasFeesApi.md#getDasFeesById) | **GET** /beta/dasFees/{dasFeesId} | Get a dasFees by id
*infoplus.DasFeesApi* | [**getDasFeesFiles**](docs/DasFeesApi.md#getDasFeesFiles) | **GET** /beta/dasFees/{dasFeesId}/file | Get the files for a dasFees.
*infoplus.DasFeesApi* | [**getDasFeesTags**](docs/DasFeesApi.md#getDasFeesTags) | **GET** /beta/dasFees/{dasFeesId}/tag | Get the tags for a dasFees.
*infoplus.DasFeesApi* | [**getDuplicateDasFeesById**](docs/DasFeesApi.md#getDuplicateDasFeesById) | **GET** /beta/dasFees/duplicate/{dasFeesId} | Get a duplicated a dasFees by id
*infoplus.DasFeesApi* | [**updateDasFees**](docs/DasFeesApi.md#updateDasFees) | **PUT** /beta/dasFees | Update a dasFees
*infoplus.DropshipApi* | [**addDropshipAudit**](docs/DropshipApi.md#addDropshipAudit) | **PUT** /beta/dropship/{dropshipId}/audit/{dropshipAudit} | Add new audit for a dropship
*infoplus.DropshipApi* | [**addDropshipFile**](docs/DropshipApi.md#addDropshipFile) | **POST** /beta/dropship/{dropshipId}/file/{fileName} | Attach a file to a dropship
*infoplus.DropshipApi* | [**addDropshipFileByURL**](docs/DropshipApi.md#addDropshipFileByURL) | **POST** /beta/dropship/{dropshipId}/file | Attach a file to a dropship by URL.
*infoplus.DropshipApi* | [**addDropshipTag**](docs/DropshipApi.md#addDropshipTag) | **PUT** /beta/dropship/{dropshipId}/tag/{dropshipTag} | Add new tags for a dropship.
*infoplus.DropshipApi* | [**deleteDropshipFile**](docs/DropshipApi.md#deleteDropshipFile) | **DELETE** /beta/dropship/{dropshipId}/file/{fileId} | Delete a file for a dropship.
*infoplus.DropshipApi* | [**deleteDropshipTag**](docs/DropshipApi.md#deleteDropshipTag) | **DELETE** /beta/dropship/{dropshipId}/tag/{dropshipTag} | Delete a tag for a dropship.
*infoplus.DropshipApi* | [**getDropshipByFilter**](docs/DropshipApi.md#getDropshipByFilter) | **GET** /beta/dropship/search | Search dropships by filter
*infoplus.DropshipApi* | [**getDropshipById**](docs/DropshipApi.md#getDropshipById) | **GET** /beta/dropship/{dropshipId} | Get a dropship by id
*infoplus.DropshipApi* | [**getDropshipFiles**](docs/DropshipApi.md#getDropshipFiles) | **GET** /beta/dropship/{dropshipId}/file | Get the files for a dropship.
*infoplus.DropshipApi* | [**getDropshipTags**](docs/DropshipApi.md#getDropshipTags) | **GET** /beta/dropship/{dropshipId}/tag | Get the tags for a dropship.
*infoplus.DropshipApi* | [**getDuplicateDropshipById**](docs/DropshipApi.md#getDuplicateDropshipById) | **GET** /beta/dropship/duplicate/{dropshipId} | Get a duplicated a dropship by id
*infoplus.DropshipApi* | [**updateDropship**](docs/DropshipApi.md#updateDropship) | **PUT** /beta/dropship | Update a dropship
...
*infoplus.ManifestPartnerApi* | [**getManifestPartnerBySearchText**](docs/ManifestPartnerApi.md#getManifestPartnerBySearchText) | **GET** /beta/manifestPartner/search | Search manifestPartners
*infoplus.ManifestPartnerApi* | [**getManifestSolutionProviderById**](docs/ManifestPartnerApi.md#getManifestSolutionProviderById) | **GET** /beta/manifestPartner/{manifestPartnerId} | Get a manifestPartner by id
...
*infoplus.ProductChargesApi* | [**addProductCharges**](docs/ProductChargesApi.md#addProductCharges) | **POST** /beta/productCharges | Create a productCharges
*infoplus.ProductChargesApi* | [**addProductChargesAudit**](docs/ProductChargesApi.md#addProductChargesAudit) | **PUT** /beta/productCharges/{productChargesId}/audit/{productChargesAudit} | Add new audit for a productCharges
*infoplus.ProductChargesApi* | [**addProductChargesFile**](docs/ProductChargesApi.md#addProductChargesFile) | **POST** /beta/productCharges/{productChargesId}/file/{fileName} | Attach a file to a productCharges
*infoplus.ProductChargesApi* | [**addProductChargesFileByURL**](docs/ProductChargesApi.md#addProductChargesFileByURL) | **POST** /beta/productCharges/{productChargesId}/file | Attach a file to a productCharges by URL.
*infoplus.ProductChargesApi* | [**addProductChargesTag**](docs/ProductChargesApi.md#addProductChargesTag) | **PUT** /beta/productCharges/{productChargesId}/tag/{productChargesTag} | Add new tags for a productCharges.
*infoplus.ProductChargesApi* | [**deleteProductCharges**](docs/ProductChargesApi.md#deleteProductCharges) | **DELETE** /beta/productCharges/{productChargesId} | Delete a productCharges
*infoplus.ProductChargesApi* | [**deleteProductChargesFile**](docs/ProductChargesApi.md#deleteProductChargesFile) | **DELETE** /beta/productCharges/{productChargesId}/file/{fileId} | Delete a file for a productCharges.
*infoplus.ProductChargesApi* | [**deleteProductChargesTag**](docs/ProductChargesApi.md#deleteProductChargesTag) | **DELETE** /beta/productCharges/{productChargesId}/tag/{productChargesTag} | Delete a tag for a productCharges.
*infoplus.ProductChargesApi* | [**getDuplicateProductChargesById**](docs/ProductChargesApi.md#getDuplicateProductChargesById) | **GET** /beta/productCharges/duplicate/{productChargesId} | Get a duplicated a productCharges by id
*infoplus.ProductChargesApi* | [**getProductChargesByFilter**](docs/ProductChargesApi.md#getProductChargesByFilter) | **GET** /beta/productCharges/search | Search productChargeses by filter
*infoplus.ProductChargesApi* | [**getProductChargesById**](docs/ProductChargesApi.md#getProductChargesById) | **GET** /beta/productCharges/{productChargesId} | Get a productCharges by id
*infoplus.ProductChargesApi* | [**getProductChargesFiles**](docs/ProductChargesApi.md#getProductChargesFiles) | **GET** /beta/productCharges/{productChargesId}/file | Get the files for a productCharges.
*infoplus.ProductChargesApi* | [**getProductChargesTags**](docs/ProductChargesApi.md#getProductChargesTags) | **GET** /beta/productCharges/{productChargesId}/tag | Get the tags for a productCharges.
*infoplus.ProductChargesApi* | [**updateProductCharges**](docs/ProductChargesApi.md#updateProductCharges) | **PUT** /beta/productCharges | Update a productCharges
...
*infoplus.RateCardApi* | [**addRateCard**](docs/RateCardApi.md#addRateCard) | **POST** /beta/rateCard | Create a rateCard
*infoplus.RateCardApi* | [**addRateCardAudit**](docs/RateCardApi.md#addRateCardAudit) | **PUT** /beta/rateCard/{rateCardId}/audit/{rateCardAudit} | Add new audit for a rateCard
*infoplus.RateCardApi* | [**addRateCardFile**](docs/RateCardApi.md#addRateCardFile) | **POST** /beta/rateCard/{rateCardId}/file/{fileName} | Attach a file to a rateCard
*infoplus.RateCardApi* | [**addRateCardFileByURL**](docs/RateCardApi.md#addRateCardFileByURL) | **POST** /beta/rateCard/{rateCardId}/file | Attach a file to a rateCard by URL.
*infoplus.RateCardApi* | [**addRateCardTag**](docs/RateCardApi.md#addRateCardTag) | **PUT** /beta/rateCard/{rateCardId}/tag/{rateCardTag} | Add new tags for a rateCard.
*infoplus.RateCardApi* | [**deleteRateCard**](docs/RateCardApi.md#deleteRateCard) | **DELETE** /beta/rateCard/{rateCardId} | Delete a rateCard
*infoplus.RateCardApi* | [**deleteRateCardFile**](docs/RateCardApi.md#deleteRateCardFile) | **DELETE** /beta/rateCard/{rateCardId}/file/{fileId} | Delete a file for a rateCard.
*infoplus.RateCardApi* | [**deleteRateCardTag**](docs/RateCardApi.md#deleteRateCardTag) | **DELETE** /beta/rateCard/{rateCardId}/tag/{rateCardTag} | Delete a tag for a rateCard.
*infoplus.RateCardApi* | [**getDuplicateRateCardById**](docs/RateCardApi.md#getDuplicateRateCardById) | **GET** /beta/rateCard/duplicate/{rateCardId} | Get a duplicated a rateCard by id
*infoplus.RateCardApi* | [**getRateCardByFilter**](docs/RateCardApi.md#getRateCardByFilter) | **GET** /beta/rateCard/search | Search rateCards by filter
*infoplus.RateCardApi* | [**getRateCardById**](docs/RateCardApi.md#getRateCardById) | **GET** /beta/rateCard/{rateCardId} | Get a rateCard by id
*infoplus.RateCardApi* | [**getRateCardFiles**](docs/RateCardApi.md#getRateCardFiles) | **GET** /beta/rateCard/{rateCardId}/file | Get the files for a rateCard.
*infoplus.RateCardApi* | [**getRateCardTags**](docs/RateCardApi.md#getRateCardTags) | **GET** /beta/rateCard/{rateCardId}/tag | Get the tags for a rateCard.
*infoplus.RateCardApi* | [**updateRateCard**](docs/RateCardApi.md#updateRateCard) | **PUT** /beta/rateCard | Update a rateCard
*infoplus.RateTypeApi* | [**getRateTypeById**](docs/RateTypeApi.md#getRateTypeById) | **GET** /beta/rateType/{rateTypeId} | Get a rateType by id
*infoplus.RateTypeApi* | [**getRateTypeBySearchText**](docs/RateTypeApi.md#getRateTypeBySearchText) | **GET** /beta/rateType/search | Search rateTypes
...
*infoplus.ReturnOrderApi* | [**addReturnOrderAudit**](docs/ReturnOrderApi.md#addReturnOrderAudit) | **PUT** /beta/returnOrder/{returnOrderId}/audit/{returnOrderAudit} | Add new audit for a returnOrder
*infoplus.ReturnOrderApi* | [**addReturnOrderFile**](docs/ReturnOrderApi.md#addReturnOrderFile) | **POST** /beta/returnOrder/{returnOrderId}/file/{fileName} | Attach a file to a returnOrder
*infoplus.ReturnOrderApi* | [**addReturnOrderFileByURL**](docs/ReturnOrderApi.md#addReturnOrderFileByURL) | **POST** /beta/returnOrder/{returnOrderId}/file | Attach a file to a returnOrder by URL.
*infoplus.ReturnOrderApi* | [**addReturnOrderTag**](docs/ReturnOrderApi.md#addReturnOrderTag) | **PUT** /beta/returnOrder/{returnOrderId}/tag/{returnOrderTag} | Add new tags for a returnOrder.
*infoplus.ReturnOrderApi* | [**deleteReturnOrderFile**](docs/ReturnOrderApi.md#deleteReturnOrderFile) | **DELETE** /beta/returnOrder/{returnOrderId}/file/{fileId} | Delete a file for a returnOrder.
*infoplus.ReturnOrderApi* | [**deleteReturnOrderTag**](docs/ReturnOrderApi.md#deleteReturnOrderTag) | **DELETE** /beta/returnOrder/{returnOrderId}/tag/{returnOrderTag} | Delete a tag for a returnOrder.
*infoplus.ReturnOrderApi* | [**getDuplicateReturnOrderById**](docs/ReturnOrderApi.md#getDuplicateReturnOrderById) | **GET** /beta/returnOrder/duplicate/{returnOrderId} | Get a duplicated a returnOrder by id
*infoplus.ReturnOrderApi* | [**getReturnOrderByFilter**](docs/ReturnOrderApi.md#getReturnOrderByFilter) | **GET** /beta/returnOrder/search | Search returnOrders by filter
*infoplus.ReturnOrderApi* | [**getReturnOrderById**](docs/ReturnOrderApi.md#getReturnOrderById) | **GET** /beta/returnOrder/{returnOrderId} | Get a returnOrder by id
*infoplus.ReturnOrderApi* | [**getReturnOrderFiles**](docs/ReturnOrderApi.md#getReturnOrderFiles) | **GET** /beta/returnOrder/{returnOrderId}/file | Get the files for a returnOrder.
*infoplus.ReturnOrderApi* | [**getReturnOrderTags**](docs/ReturnOrderApi.md#getReturnOrderTags) | **GET** /beta/returnOrder/{returnOrderId}/tag | Get the tags for a returnOrder.
*infoplus.ReturnOrderApi* | [**updateReturnOrder**](docs/ReturnOrderApi.md#updateReturnOrder) | **PUT** /beta/returnOrder | Update a returnOrder
*infoplus.ReturnOrderApi* | [**updateReturnOrderCustomFields**](docs/ReturnOrderApi.md#updateReturnOrderCustomFields) | **PUT** /beta/returnOrder/customFields | Update a returnOrder custom fields
*infoplus.ReturnOrderLineApi* | [**addReturnOrderLineAudit**](docs/ReturnOrderLineApi.md#addReturnOrderLineAudit) | **PUT** /beta/returnOrderLine/{returnOrderLineId}/audit/{returnOrderLineAudit} | Add new audit for a returnOrderLine
*infoplus.ReturnOrderLineApi* | [**addReturnOrderLineFile**](docs/ReturnOrderLineApi.md#addReturnOrderLineFile) | **POST** /beta/returnOrderLine/{returnOrderLineId}/file/{fileName} | Attach a file to a returnOrderLine
*infoplus.ReturnOrderLineApi* | [**addReturnOrderLineFileByURL**](docs/ReturnOrderLineApi.md#addReturnOrderLineFileByURL) | **POST** /beta/returnOrderLine/{returnOrderLineId}/file | Attach a file to a returnOrderLine by URL.
*infoplus.ReturnOrderLineApi* | [**addReturnOrderLineTag**](docs/ReturnOrderLineApi.md#addReturnOrderLineTag) | **PUT** /beta/returnOrderLine/{returnOrderLineId}/tag/{returnOrderLineTag} | Add new tags for a returnOrderLine.
*infoplus.ReturnOrderLineApi* | [**deleteReturnOrderLineFile**](docs/ReturnOrderLineApi.md#deleteReturnOrderLineFile) | **DELETE** /beta/returnOrderLine/{returnOrderLineId}/file/{fileId} | Delete a file for a returnOrderLine.
*infoplus.ReturnOrderLineApi* | [**deleteReturnOrderLineTag**](docs/ReturnOrderLineApi.md#deleteReturnOrderLineTag) | **DELETE** /beta/returnOrderLine/{returnOrderLineId}/tag/{returnOrderLineTag} | Delete a tag for a returnOrderLine.
*infoplus.ReturnOrderLineApi* | [**getDuplicateReturnOrderLineById**](docs/ReturnOrderLineApi.md#getDuplicateReturnOrderLineById) | **GET** /beta/returnOrderLine/duplicate/{returnOrderLineId} | Get a duplicated a returnOrderLine by id
*infoplus.ReturnOrderLineApi* | [**getReturnOrderLineByFilter**](docs/ReturnOrderLineApi.md#getReturnOrderLineByFilter) | **GET** /beta/returnOrderLine/search | Search returnOrderLines by filter
*infoplus.ReturnOrderLineApi* | [**getReturnOrderLineById**](docs/ReturnOrderLineApi.md#getReturnOrderLineById) | **GET** /beta/returnOrderLine/{returnOrderLineId} | Get a returnOrderLine by id
*infoplus.ReturnOrderLineApi* | [**getReturnOrderLineFiles**](docs/ReturnOrderLineApi.md#getReturnOrderLineFiles) | **GET** /beta/returnOrderLine/{returnOrderLineId}/file | Get the files for a returnOrderLine.
*infoplus.ReturnOrderLineApi* | [**getReturnOrderLineTags**](docs/ReturnOrderLineApi.md#getReturnOrderLineTags) | **GET** /beta/returnOrderLine/{returnOrderLineId}/tag | Get the tags for a returnOrderLine.
*infoplus.ReturnOrderLineApi* | [**updateReturnOrderLineCustomFields**](docs/ReturnOrderLineApi.md#updateReturnOrderLineCustomFields) | **PUT** /beta/returnOrderLine/customFields | Update a returnOrderLine custom fields
*infoplus.ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsAudit**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsAudit) | **PUT** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/audit/{returnOrderLineDetailsAudit} | Add new audit for a returnOrderLineDetails
*infoplus.ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsFile**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsFile) | **POST** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file/{fileName} | Attach a file to a returnOrderLineDetails
*infoplus.ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsFileByURL**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsFileByURL) | **POST** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file | Attach a file to a returnOrderLineDetails by URL.
*infoplus.ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsTag**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsTag) | **PUT** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag/{returnOrderLineDetailsTag} | Add new tags for a returnOrderLineDetails.
*infoplus.ReturnOrderLineDetailsApi* | [**deleteReturnOrderLineDetailsFile**](docs/ReturnOrderLineDetailsApi.md#deleteReturnOrderLineDetailsFile) | **DELETE** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file/{fileId} | Delete a file for a returnOrderLineDetails.
*infoplus.ReturnOrderLineDetailsApi* | [**deleteReturnOrderLineDetailsTag**](docs/ReturnOrderLineDetailsApi.md#deleteReturnOrderLineDetailsTag) | **DELETE** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag/{returnOrderLineDetailsTag} | Delete a tag for a returnOrderLineDetails.
*infoplus.ReturnOrderLineDetailsApi* | [**getDuplicateReturnOrderLineDetailsById**](docs/ReturnOrderLineDetailsApi.md#getDuplicateReturnOrderLineDetailsById) | **GET** /beta/returnOrderLineDetails/duplicate/{returnOrderLineDetailsId} | Get a duplicated a returnOrderLineDetails by id
*infoplus.ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsByFilter**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsByFilter) | **GET** /beta/returnOrderLineDetails/search | Search returnOrderLineDetailses by filter
*infoplus.ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsById**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsById) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId} | Get a returnOrderLineDetails by id
*infoplus.ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsFiles**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsFiles) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file | Get the files for a returnOrderLineDetails.
*infoplus.ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsTags**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsTags) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag | Get the tags for a returnOrderLineDetails.
*infoplus.ReturnOrderLineDetailsApi* | [**updateReturnOrderLineDetailsCustomFields**](docs/ReturnOrderLineDetailsApi.md#updateReturnOrderLineDetailsCustomFields) | **PUT** /beta/returnOrderLineDetails/customFields | Update a returnOrderLineDetails custom fields
*infoplus.ReturnShipmentApi* | [**addReturnShipmentAudit**](docs/ReturnShipmentApi.md#addReturnShipmentAudit) | **PUT** /beta/returnShipment/{returnShipmentId}/audit/{returnShipmentAudit} | Add new audit for a returnShipment
*infoplus.ReturnShipmentApi* | [**addReturnShipmentFile**](docs/ReturnShipmentApi.md#addReturnShipmentFile) | **POST** /beta/returnShipment/{returnShipmentId}/file/{fileName} | Attach a file to a returnShipment
*infoplus.ReturnShipmentApi* | [**addReturnShipmentFileByURL**](docs/ReturnShipmentApi.md#addReturnShipmentFileByURL) | **POST** /beta/returnShipment/{returnShipmentId}/file | Attach a file to a returnShipment by URL.
*infoplus.ReturnShipmentApi* | [**addReturnShipmentTag**](docs/ReturnShipmentApi.md#addReturnShipmentTag) | **PUT** /beta/returnShipment/{returnShipmentId}/tag/{returnShipmentTag} | Add new tags for a returnShipment.
*infoplus.ReturnShipmentApi* | [**deleteReturnShipmentFile**](docs/ReturnShipmentApi.md#deleteReturnShipmentFile) | **DELETE** /beta/returnShipment/{returnShipmentId}/file/{fileId} | Delete a file for a returnShipment.
*infoplus.ReturnShipmentApi* | [**deleteReturnShipmentTag**](docs/ReturnShipmentApi.md#deleteReturnShipmentTag) | **DELETE** /beta/returnShipment/{returnShipmentId}/tag/{returnShipmentTag} | Delete a tag for a returnShipment.
*infoplus.ReturnShipmentApi* | [**getDuplicateReturnShipmentById**](docs/ReturnShipmentApi.md#getDuplicateReturnShipmentById) | **GET** /beta/returnShipment/duplicate/{returnShipmentId} | Get a duplicated a returnShipment by id
*infoplus.ReturnShipmentApi* | [**getReturnShipmentByFilter**](docs/ReturnShipmentApi.md#getReturnShipmentByFilter) | **GET** /beta/returnShipment/search | Search returnShipments by filter
*infoplus.ReturnShipmentApi* | [**getReturnShipmentById**](docs/ReturnShipmentApi.md#getReturnShipmentById) | **GET** /beta/returnShipment/{returnShipmentId} | Get a returnShipment by id
*infoplus.ReturnShipmentApi* | [**getReturnShipmentFiles**](docs/ReturnShipmentApi.md#getReturnShipmentFiles) | **GET** /beta/returnShipment/{returnShipmentId}/file | Get the files for a returnShipment.
*infoplus.ReturnShipmentApi* | [**getReturnShipmentTags**](docs/ReturnShipmentApi.md#getReturnShipmentTags) | **GET** /beta/returnShipment/{returnShipmentId}/tag | Get the tags for a returnShipment.
*infoplus.ReturnShipmentApi* | [**updateReturnShipmentCustomFields**](docs/ReturnShipmentApi.md#updateReturnShipmentCustomFields) | **PUT** /beta/returnShipment/customFields | Update a returnShipment custom fields
...
*infoplus.UspsHazmatTypeApi* | [**getUSPSHazmatTypeById**](docs/UspsHazmatTypeApi.md#getUSPSHazmatTypeById) | **GET** /beta/uspsHazmatType/{uspsHazmatTypeId} | Get an uspsHazmatType by id
*infoplus.UspsHazmatTypeApi* | [**getUspsHazmatTypeBySearchText**](docs/UspsHazmatTypeApi.md#getUspsHazmatTypeBySearchText) | **GET** /beta/uspsHazmatType/search | Search uspsHazmatTypes
...
*infoplus.WarehouseInventoryApi* | [**addWarehouseInventoryAudit**](docs/WarehouseInventoryApi.md#addWarehouseInventoryAudit) | **PUT** /beta/warehouseInventory/{warehouseInventoryId}/audit/{warehouseInventoryAudit} | Add new audit for a warehouseInventory
*infoplus.WarehouseInventoryApi* | [**addWarehouseInventoryFile**](docs/WarehouseInventoryApi.md#addWarehouseInventoryFile) | **POST** /beta/warehouseInventory/{warehouseInventoryId}/file/{fileName} | Attach a file to a warehouseInventory
*infoplus.WarehouseInventoryApi* | [**addWarehouseInventoryFileByURL**](docs/WarehouseInventoryApi.md#addWarehouseInventoryFileByURL) | **POST** /beta/warehouseInventory/{warehouseInventoryId}/file | Attach a file to a warehouseInventory by URL.
*infoplus.WarehouseInventoryApi* | [**addWarehouseInventoryTag**](docs/WarehouseInventoryApi.md#addWarehouseInventoryTag) | **PUT** /beta/warehouseInventory/{warehouseInventoryId}/tag/{warehouseInventoryTag} | Add new tags for a warehouseInventory.
*infoplus.WarehouseInventoryApi* | [**deleteWarehouseInventoryFile**](docs/WarehouseInventoryApi.md#deleteWarehouseInventoryFile) | **DELETE** /beta/warehouseInventory/{warehouseInventoryId}/file/{fileId} | Delete a file for a warehouseInventory.
*infoplus.WarehouseInventoryApi* | [**deleteWarehouseInventoryTag**](docs/WarehouseInventoryApi.md#deleteWarehouseInventoryTag) | **DELETE** /beta/warehouseInventory/{warehouseInventoryId}/tag/{warehouseInventoryTag} | Delete a tag for a warehouseInventory.
*infoplus.WarehouseInventoryApi* | [**getDuplicateWarehouseInventoryById**](docs/WarehouseInventoryApi.md#getDuplicateWarehouseInventoryById) | **GET** /beta/warehouseInventory/duplicate/{warehouseInventoryId} | Get a duplicated a warehouseInventory by id
*infoplus.WarehouseInventoryApi* | [**getWarehouseInventoryByFilter**](docs/WarehouseInventoryApi.md#getWarehouseInventoryByFilter) | **GET** /beta/warehouseInventory/search | Search warehouseInventorys by filter
*infoplus.WarehouseInventoryApi* | [**getWarehouseInventoryById**](docs/WarehouseInventoryApi.md#getWarehouseInventoryById) | **GET** /beta/warehouseInventory/{warehouseInventoryId} | Get a warehouseInventory by id
*infoplus.WarehouseInventoryApi* | [**getWarehouseInventoryFiles**](docs/WarehouseInventoryApi.md#getWarehouseInventoryFiles) | **GET** /beta/warehouseInventory/{warehouseInventoryId}/file | Get the files for a warehouseInventory.
*infoplus.WarehouseInventoryApi* | [**getWarehouseInventoryTags**](docs/WarehouseInventoryApi.md#getWarehouseInventoryTags) | **GET** /beta/warehouseInventory/{warehouseInventoryId}/tag | Get the tags for a warehouseInventory.
...
*infoplus.ZipCodeZoneApi* | [**addZipCodeZone**](docs/ZipCodeZoneApi.md#addZipCodeZone) | **POST** /beta/zipCodeZone | Create a zipCodeZone
*infoplus.ZipCodeZoneApi* | [**addZipCodeZoneAudit**](docs/ZipCodeZoneApi.md#addZipCodeZoneAudit) | **PUT** /beta/zipCodeZone/{zipCodeZoneId}/audit/{zipCodeZoneAudit} | Add new audit for a zipCodeZone
*infoplus.ZipCodeZoneApi* | [**addZipCodeZoneFile**](docs/ZipCodeZoneApi.md#addZipCodeZoneFile) | **POST** /beta/zipCodeZone/{zipCodeZoneId}/file/{fileName} | Attach a file to a zipCodeZone
*infoplus.ZipCodeZoneApi* | [**addZipCodeZoneFileByURL**](docs/ZipCodeZoneApi.md#addZipCodeZoneFileByURL) | **POST** /beta/zipCodeZone/{zipCodeZoneId}/file | Attach a file to a zipCodeZone by URL.
*infoplus.ZipCodeZoneApi* | [**addZipCodeZoneTag**](docs/ZipCodeZoneApi.md#addZipCodeZoneTag) | **PUT** /beta/zipCodeZone/{zipCodeZoneId}/tag/{zipCodeZoneTag} | Add new tags for a zipCodeZone.
*infoplus.ZipCodeZoneApi* | [**deleteZipCodeZone**](docs/ZipCodeZoneApi.md#deleteZipCodeZone) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId} | Delete a zipCodeZone
*infoplus.ZipCodeZoneApi* | [**deleteZipCodeZoneFile**](docs/ZipCodeZoneApi.md#deleteZipCodeZoneFile) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId}/file/{fileId} | Delete a file for a zipCodeZone.
*infoplus.ZipCodeZoneApi* | [**deleteZipCodeZoneTag**](docs/ZipCodeZoneApi.md#deleteZipCodeZoneTag) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId}/tag/{zipCodeZoneTag} | Delete a tag for a zipCodeZone.
*infoplus.ZipCodeZoneApi* | [**getDuplicateZipCodeZoneById**](docs/ZipCodeZoneApi.md#getDuplicateZipCodeZoneById) | **GET** /beta/zipCodeZone/duplicate/{zipCodeZoneId} | Get a duplicated a zipCodeZone by id
*infoplus.ZipCodeZoneApi* | [**getZipCodeZoneByFilter**](docs/ZipCodeZoneApi.md#getZipCodeZoneByFilter) | **GET** /beta/zipCodeZone/search | Search zipCodeZones by filter
*infoplus.ZipCodeZoneApi* | [**getZipCodeZoneById**](docs/ZipCodeZoneApi.md#getZipCodeZoneById) | **GET** /beta/zipCodeZone/{zipCodeZoneId} | Get a zipCodeZone by id
*infoplus.ZipCodeZoneApi* | [**getZipCodeZoneFiles**](docs/ZipCodeZoneApi.md#getZipCodeZoneFiles) | **GET** /beta/zipCodeZone/{zipCodeZoneId}/file | Get the files for a zipCodeZone.
*infoplus.ZipCodeZoneApi* | [**getZipCodeZoneTags**](docs/ZipCodeZoneApi.md#getZipCodeZoneTags) | **GET** /beta/zipCodeZone/{zipCodeZoneId}/tag | Get the tags for a zipCodeZone.
*infoplus.ZipCodeZoneApi* | [**updateZipCodeZone**](docs/ZipCodeZoneApi.md#updateZipCodeZone) | **PUT** /beta/zipCodeZone | Update a zipCodeZone
...
## Documentation for Models
 ...
 - [infoplus.CarrierCompanyCode](docs/CarrierCompanyCode.md)
 ...
 - [infoplus.ClosePurchProcessInputAPIModel](docs/ClosePurchProcessInputAPIModel.md)
 - [infoplus.CommodityCode](docs/CommodityCode.md)
 ...
 - [infoplus.DasFeeType](docs/DasFeeType.md)
 - [infoplus.DasFees](docs/DasFees.md)
 - [infoplus.Dropship](docs/Dropship.md)
 ...
 - [infoplus.ExecuteExternalShipmentInputAPIModel](docs/ExecuteExternalShipmentInputAPIModel.md)
 ...
 - [infoplus.GS1128LabelDTO](docs/GS1128LabelDTO.md)
 ...
 - [infoplus.ManifestPartner](docs/ManifestPartner.md)
 ...
 - [infoplus.ProductCharges](docs/ProductCharges.md)
 ...
 - [infoplus.RateCard](docs/RateCard.md)
 - [infoplus.RateType](docs/RateType.md)
 ...
 - [infoplus.ReturnOrder](docs/ReturnOrder.md)
 - [infoplus.ReturnOrderLine](docs/ReturnOrderLine.md)
 - [infoplus.ReturnOrderLineDetails](docs/ReturnOrderLineDetails.md)
 - [infoplus.ReturnShipment](docs/ReturnShipment.md)
 ...
 - [infoplus.UspsHazmatType](docs/UspsHazmatType.md)
 ...
 - [infoplus.WarehouseInventory](docs/WarehouseInventory.md)
 ...
 - [infoplus.ZipCodeZone](docs/ZipCodeZone.md)
